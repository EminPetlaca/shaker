...
(function (global, factory) {
  ...
  const AArrowDown = createLucideIcon("a-arrow-down", __iconNode$ot);
  ...
  const AArrowUp = createLucideIcon("a-arrow-up", __iconNode$os);
  ...
  const ALargeSmall = createLucideIcon("a-large-small", __iconNode$or);
  ...
  const Accessibility = createLucideIcon("accessibility", __iconNode$oq);
  ...
  const Activity = createLucideIcon("activity", __iconNode$op);
  ...
  const AirVent = createLucideIcon("air-vent", __iconNode$oo);
  ...
  const Airplay = createLucideIcon("airplay", __iconNode$on);
  ...
  const AlarmClockCheck = createLucideIcon("alarm-clock-check", __iconNode$om);
  ...
  const AlarmClockMinus = createLucideIcon("alarm-clock-minus", __iconNode$ol);
  ...
  const AlarmClockOff = createLucideIcon("alarm-clock-off", __iconNode$ok);
  ...
  const AlarmClockPlus = createLucideIcon("alarm-clock-plus", __iconNode$oj);
  ...
  const AlarmClock = createLucideIcon("alarm-clock", __iconNode$oi);
  ...
  const AlarmSmoke = createLucideIcon("alarm-smoke", __iconNode$oh);

  const __iconNode$og = [
    ["rect", { width: "18", height: "18", x: "3", y: "3", rx: "2", ry: "2", key: "1m3agn" }],
    ["polyline", { points: "11 3 11 11 14 8 17 11 17 3", key: "1wcwz3" }]
  ];
  const Album = createLucideIcon("album", __iconNode$og);
  ...
  const AlignEndHorizontal = createLucideIcon("align-end-horizontal", __iconNode$oc);
  ...
  const AlignEndVertical = createLucideIcon("align-end-vertical", __iconNode$ob);
  ...
  const AlignHorizontalJustifyEnd = createLucideIcon("align-horizontal-justify-end", __iconNode$o6);
  ...
  const AlignHorizontalJustifyStart = createLucideIcon("align-horizontal-justify-start", __iconNode$o5);
  ...
  const AlignHorizontalSpaceAround = createLucideIcon("align-horizontal-space-around", __iconNode$o4);
  ...
  const AlignHorizontalSpaceBetween = createLucideIcon("align-horizontal-space-between", __iconNode$o3);
  ...
  const AlignJustify = createLucideIcon("align-justify", __iconNode$o2);
  ...
  const AlignLeft = createLucideIcon("align-left", __iconNode$o1);
  ...
  const AlignRight = createLucideIcon("align-right", __iconNode$o0);
  ...
  const AlignStartHorizontal = createLucideIcon("align-start-horizontal", __iconNode$n$);
  ...
  const AlignStartVertical = createLucideIcon("align-start-vertical", __iconNode$n_);
  ...
  const AlignVerticalDistributeEnd = createLucideIcon("align-vertical-distribute-end", __iconNode$nY);
  ...
  const AlignVerticalJustifyCenter = createLucideIcon("align-vertical-justify-center", __iconNode$nW);
  ...
  const AlignVerticalJustifyEnd = createLucideIcon("align-vertical-justify-end", __iconNode$nV);
  ...
  const AlignVerticalJustifyStart = createLucideIcon("align-vertical-justify-start", __iconNode$nU);
  ...
  const AlignVerticalSpaceAround = createLucideIcon("align-vertical-space-around", __iconNode$nT);
  ...
  const AlignVerticalSpaceBetween = createLucideIcon("align-vertical-space-between", __iconNode$nS);
  ...
  const Ambulance = createLucideIcon("ambulance", __iconNode$nR);
  ...
  const Ampersand = createLucideIcon("ampersand", __iconNode$nQ);
  ...
  const Ampersands = createLucideIcon("ampersands", __iconNode$nP);
  ...
  const Amphora = createLucideIcon("amphora", __iconNode$nO);
  ...
  const Anchor = createLucideIcon("anchor", __iconNode$nN);
  ...
  const Angry = createLucideIcon("angry", __iconNode$nM);
  ...
  const Annoyed = createLucideIcon("annoyed", __iconNode$nL);
  ...
  const Antenna = createLucideIcon("antenna", __iconNode$nK);
  ...
  const Anvil = createLucideIcon("anvil", __iconNode$nJ);
  ...
  const Aperture = createLucideIcon("aperture", __iconNode$nI);
  ...
  const AppWindowMac = createLucideIcon("app-window-mac", __iconNode$nH);
  ...
  const AppWindow = createLucideIcon("app-window", __iconNode$nG);
  ...
  const Apple = createLucideIcon("apple", __iconNode$nF);
  ...
  const ArchiveRestore = createLucideIcon("archive-restore", __iconNode$nE);
  ...
  const ArchiveX = createLucideIcon("archive-x", __iconNode$nD);
  ...
  const Archive = createLucideIcon("archive", __iconNode$nC);
  ...
  const Armchair = createLucideIcon("armchair", __iconNode$nB);

  const __iconNode$nA = [
    ["path", { d: "M15 5H9", key: "1tp3ed" }],
    ["path", { d: "M15 9v3h4l-7 7-7-7h4V9z", key: "ncdc4b" }]
  ];
  const ArrowBigDownDash = createLucideIcon("arrow-big-down-dash", __iconNode$nA);

  const __iconNode$nz = [["path", { d: "M15 6v6h4l-7 7-7-7h4V6h6z", key: "1thax2" }]];
  const ArrowBigDown = createLucideIcon("arrow-big-down", __iconNode$nz);

  const __iconNode$ny = [
    ["path", { d: "M19 15V9", key: "1hci5f" }],
    ["path", { d: "M15 15h-3v4l-7-7 7-7v4h3v6z", key: "16tjna" }]
  ];
  const ArrowBigLeftDash = createLucideIcon("arrow-big-left-dash", __iconNode$ny);

  const __iconNode$nx = [["path", { d: "M18 15h-6v4l-7-7 7-7v4h6v6z", key: "lbrdak" }]];
  const ArrowBigLeft = createLucideIcon("arrow-big-left", __iconNode$nx);

  const __iconNode$nw = [
    ["path", { d: "M5 9v6", key: "158jrl" }],
    ["path", { d: "M9 9h3V5l7 7-7 7v-4H9V9z", key: "1sg2xn" }]
  ];
  const ArrowBigRightDash = createLucideIcon("arrow-big-right-dash", __iconNode$nw);

  const __iconNode$nv = [["path", { d: "M6 9h6V5l7 7-7 7v-4H6V9z", key: "7fvt9c" }]];
  const ArrowBigRight = createLucideIcon("arrow-big-right", __iconNode$nv);
  ...
  const __iconNode$nt = [["path", { d: "M9 18v-6H5l7-7 7 7h-4v6H9z", key: "1x06kx" }]];
  const ArrowBigUp = createLucideIcon("arrow-big-up", __iconNode$nt);
  ...
  const ArrowDown01 = createLucideIcon("arrow-down-0-1", __iconNode$ns);
  ...
  const ArrowDown10 = createLucideIcon("arrow-down-1-0", __iconNode$nr);
  ...
  const ArrowDownAZ = createLucideIcon("arrow-down-a-z", __iconNode$nq);
  ...
  const ArrowDownFromLine = createLucideIcon("arrow-down-from-line", __iconNode$np);

  const __iconNode$no = [
    ["path", { d: "M17 7 7 17", key: "15tmo1" }],
    ["path", { d: "M17 17H7V7", key: "1org7z" }]
  ];
  const ArrowDownLeft = createLucideIcon("arrow-down-left", __iconNode$no);
  ...
  const ArrowDownNarrowWide = createLucideIcon("arrow-down-narrow-wide", __iconNode$nn);

  const __iconNode$nm = [
    ["path", { d: "m7 7 10 10", key: "1fmybs" }],
    ["path", { d: "M17 7v10H7", key: "6fjiku" }]
  ];
  const ArrowDownRight = createLucideIcon("arrow-down-right", __iconNode$nm);
  ...
  const ArrowDownToDot = createLucideIcon("arrow-down-to-dot", __iconNode$nl);
  ...
  const ArrowDownToLine = createLucideIcon("arrow-down-to-line", __iconNode$nk);
  ...
  const ArrowDownUp = createLucideIcon("arrow-down-up", __iconNode$nj);
  ...
  const ArrowDownWideNarrow = createLucideIcon("arrow-down-wide-narrow", __iconNode$ni);
  ...
  const ArrowDownZA = createLucideIcon("arrow-down-z-a", __iconNode$nh);

  const __iconNode$ng = [
    ["path", { d: "M12 5v14", key: "s699le" }],
    ["path", { d: "m19 12-7 7-7-7", key: "1idqje" }]
  ];
  const ArrowDown = createLucideIcon("arrow-down", __iconNode$ng);
  ...
  const ArrowLeftFromLine = createLucideIcon("arrow-left-from-line", __iconNode$nf);
  ...
  const ArrowLeftToLine = createLucideIcon("arrow-left-to-line", __iconNode$nd);
  ...
  const ArrowRightFromLine = createLucideIcon("arrow-right-from-line", __iconNode$nb);
  ...
  const ArrowRightLeft = createLucideIcon("arrow-right-left", __iconNode$na);
  ...
  const ArrowRightToLine = createLucideIcon("arrow-right-to-line", __iconNode$n9);

  const __iconNode$n8 = [
    ["path", { d: "M5 12h14", key: "1ays0h" }],
    ["path", { d: "m12 5 7 7-7 7", key: "xquz4c" }]
  ];
  const ArrowRight = createLucideIcon("arrow-right", __iconNode$n8);
  ...
  const ArrowUp01 = createLucideIcon("arrow-up-0-1", __iconNode$n7);
  ...
  const ArrowUp10 = createLucideIcon("arrow-up-1-0", __iconNode$n6);
  ...
  const ArrowUpAZ = createLucideIcon("arrow-up-a-z", __iconNode$n5);
  ...
  const ArrowUpDown = createLucideIcon("arrow-up-down", __iconNode$n4);
  ...
  const ArrowUpFromDot = createLucideIcon("arrow-up-from-dot", __iconNode$n3);
  ...
  const ArrowUpFromLine = createLucideIcon("arrow-up-from-line", __iconNode$n2);

  const __iconNode$n1 = [
    ["path", { d: "M7 17V7h10", key: "11bw93" }],
    ["path", { d: "M17 17 7 7", key: "2786uv" }]
  ];
  const ArrowUpLeft = createLucideIcon("arrow-up-left", __iconNode$n1);
  ...
  const ArrowUpNarrowWide = createLucideIcon("arrow-up-narrow-wide", __iconNode$n0);
  ...
  const ArrowUpToLine = createLucideIcon("arrow-up-to-line", __iconNode$m_);
  ...
  const ArrowUpWideNarrow = createLucideIcon("arrow-up-wide-narrow", __iconNode$mZ);
  ...
  const ArrowUpZA = createLucideIcon("arrow-up-z-a", __iconNode$mY);

  const __iconNode$mX = [
    ["path", { d: "m5 12 7-7 7 7", key: "hav0vg" }],
    ["path", { d: "M12 19V5", key: "x0mq9r" }]
  ];
  const ArrowUp = createLucideIcon("arrow-up", __iconNode$mX);
  ...
  const ArrowsUpFromLine = createLucideIcon("arrows-up-from-line", __iconNode$mW);
  ...
  const Asterisk = createLucideIcon("asterisk", __iconNode$mV);

  const __iconNode$mU = [
    ["circle", { cx: "12", cy: "12", r: "4", key: "4exip2" }],
    ["path", { d: "M16 8v5a3 3 0 0 0 6 0v-1a10 10 0 1 0-4 8", key: "7n84p3" }]
  ];
  const AtSign = createLucideIcon("at-sign", __iconNode$mU);
  ...
  const Atom = createLucideIcon("atom", __iconNode$mT);
  ...
  const AudioLines = createLucideIcon("audio-lines", __iconNode$mS);
  ...
  const AudioWaveform = createLucideIcon("audio-waveform", __iconNode$mR);
  ...
  const Baby = createLucideIcon("baby", __iconNode$mN);
  ...
  const Backpack = createLucideIcon("backpack", __iconNode$mM);
  ...
  const BadgeAlert = createLucideIcon("badge-alert", __iconNode$mL);
  ...
  const BadgeCent = createLucideIcon("badge-cent", __iconNode$mK);
  ...
  const BadgeCheck = createLucideIcon("badge-check", __iconNode$mJ);
  ...
  const BadgeDollarSign = createLucideIcon("badge-dollar-sign", __iconNode$mI);
  ...
  const BadgeEuro = createLucideIcon("badge-euro", __iconNode$mH);
  ...
  const BadgeHelp = createLucideIcon("badge-help", __iconNode$mG);
  ...
  const BadgeIndianRupee = createLucideIcon("badge-indian-rupee", __iconNode$mF);
  ...
  const BadgeInfo = createLucideIcon("badge-info", __iconNode$mE);
  ...
  const BadgeRussianRuble = createLucideIcon("badge-russian-ruble", __iconNode$my);
  ...
  const BadgeSwissFranc = createLucideIcon("badge-swiss-franc", __iconNode$mx);
  ...
  const BadgeX = createLucideIcon("badge-x", __iconNode$mw);
  ...
  const BaggageClaim = createLucideIcon("baggage-claim", __iconNode$mu);

  const __iconNode$mt = [
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
    ["path", { d: "m4.9 4.9 14.2 14.2", key: "1m5liu" }]
  ];
  const Ban = createLucideIcon("ban", __iconNode$mt);
  ...
  const Bandage = createLucideIcon("bandage", __iconNode$ms);
  ...
  const BanknoteArrowDown = createLucideIcon("banknote-arrow-down", __iconNode$mq);
  ...
  const BanknoteArrowUp = createLucideIcon("banknote-arrow-up", __iconNode$mp);
  ...
  const BanknoteX = createLucideIcon("banknote-x", __iconNode$mo);
  ...
  const Banknote = createLucideIcon("banknote", __iconNode$mn);
  ...
  const Barcode = createLucideIcon("barcode", __iconNode$mm);
  ...
  const Baseline = createLucideIcon("baseline", __iconNode$ml);
  ...
  const Bath = createLucideIcon("bath", __iconNode$mk);
  ...
  const BatteryCharging = createLucideIcon("battery-charging", __iconNode$mj);
  ...
  const BatteryFull = createLucideIcon("battery-full", __iconNode$mi);
  ...
  const BatteryLow = createLucideIcon("battery-low", __iconNode$mh);
  ...
  const BatteryMedium = createLucideIcon("battery-medium", __iconNode$mg);
  ...
  const BatteryPlus = createLucideIcon("battery-plus", __iconNode$mf);
  ...
  const BeanOff = createLucideIcon("bean-off", __iconNode$mb);
  ...
  const Bean = createLucideIcon("bean", __iconNode$ma);
  ...
  const Beer = createLucideIcon("beer", __iconNode$m4);
  ...
  const BellDot = createLucideIcon("bell-dot", __iconNode$m3);
  ...
  const BellElectric = createLucideIcon("bell-electric", __iconNode$m2);
  ...
  const BellMinus = createLucideIcon("bell-minus", __iconNode$m1);
  ...
  const BellOff = createLucideIcon("bell-off", __iconNode$m0);
  ...
  const BellPlus = createLucideIcon("bell-plus", __iconNode$l$);
  ...
  const BellRing = createLucideIcon("bell-ring", __iconNode$l_);
  ...
  const Bell = createLucideIcon("bell", __iconNode$lZ);
  ...
  const BetweenHorizontalEnd = createLucideIcon("between-horizontal-end", __iconNode$lY);
  ...
  const BetweenHorizontalStart = createLucideIcon("between-horizontal-start", __iconNode$lX);
  ...
  const BetweenVerticalEnd = createLucideIcon("between-vertical-end", __iconNode$lW);
  ...
  const BetweenVerticalStart = createLucideIcon("between-vertical-start", __iconNode$lV);
  ...
  const BicepsFlexed = createLucideIcon("biceps-flexed", __iconNode$lU);
  ...
  const Bike = createLucideIcon("bike", __iconNode$lT);
  ...
  const Binary = createLucideIcon("binary", __iconNode$lS);
  ...
  const Binoculars = createLucideIcon("binoculars", __iconNode$lR);
  ...
  const Biohazard = createLucideIcon("biohazard", __iconNode$lQ);
  ...
  const Bird = createLucideIcon("bird", __iconNode$lP);
  ...
  const Bitcoin = createLucideIcon("bitcoin", __iconNode$lO);

  const __iconNode$lN = [
    ["circle", { cx: "9", cy: "9", r: "7", key: "p2h5vp" }],
    ["circle", { cx: "15", cy: "15", r: "7", key: "19ennj" }]
  ];
  const Blend = createLucideIcon("blend", __iconNode$lN);
  ...
  const Blinds = createLucideIcon("blinds", __iconNode$lM);
  ...
  const Blocks = createLucideIcon("blocks", __iconNode$lL);
  ...
  const BluetoothConnected = createLucideIcon("bluetooth-connected", __iconNode$lK);
  ...
  const BluetoothOff = createLucideIcon("bluetooth-off", __iconNode$lJ);
  ...
  const BluetoothSearching = createLucideIcon("bluetooth-searching", __iconNode$lI);

  const __iconNode$lH = [["path", { d: "m7 7 10 10-5 5V2l5 5L7 17", key: "1q5490" }]];
  const Bluetooth = createLucideIcon("bluetooth", __iconNode$lH);
  ...
  const Bold = createLucideIcon("bold", __iconNode$lG);
  ...
  const Bolt = createLucideIcon("bolt", __iconNode$lF);
  ...
  const Bomb = createLucideIcon("bomb", __iconNode$lE);
  ...
  const Bone = createLucideIcon("bone", __iconNode$lD);
  ...
  const BookA = createLucideIcon("book-a", __iconNode$lC);
  ...
  const BookAudio = createLucideIcon("book-audio", __iconNode$lB);
  ...
  const BookCheck = createLucideIcon("book-check", __iconNode$lA);
  ...
  const BookDashed = createLucideIcon("book-dashed", __iconNode$ly);
  ...
  const BookDown = createLucideIcon("book-down", __iconNode$lx);
  ...
  const BookHeadphones = createLucideIcon("book-headphones", __iconNode$lw);
  ...
  const BookHeart = createLucideIcon("book-heart", __iconNode$lv);
  ...
  const BookImage = createLucideIcon("book-image", __iconNode$lu);
  ...
  const BookKey = createLucideIcon("book-key", __iconNode$lt);
  ...
  const BookLock = createLucideIcon("book-lock", __iconNode$ls);
  ...
  const BookMarked = createLucideIcon("book-marked", __iconNode$lr);
  ...
  const BookMinus = createLucideIcon("book-minus", __iconNode$lq);
  ...
  const BookOpenCheck = createLucideIcon("book-open-check", __iconNode$lp);
  ...
  const BookOpenText = createLucideIcon("book-open-text", __iconNode$lo);
  ...
  const BookOpen = createLucideIcon("book-open", __iconNode$ln);
  ...
  const BookPlus = createLucideIcon("book-plus", __iconNode$lm);
  ...
  const BookText = createLucideIcon("book-text", __iconNode$ll);
  ...
  const BookUp2 = createLucideIcon("book-up-2", __iconNode$lj);
  ...
  const BookUp = createLucideIcon("book-up", __iconNode$li);
  ...
  const BookUser = createLucideIcon("book-user", __iconNode$lh);
  ...
  const BookX = createLucideIcon("book-x", __iconNode$lg);
  ...
  const Book = createLucideIcon("book", __iconNode$lf);

  const __iconNode$le = [
    ["path", { d: "m19 21-7-4-7 4V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2Z", key: "169p4p" }],
    ["path", { d: "m9 10 2 2 4-4", key: "1gnqz4" }]
  ];
  const BookmarkCheck = createLucideIcon("bookmark-check", __iconNode$le);
  ...
  const BookmarkPlus = createLucideIcon("bookmark-plus", __iconNode$lc);
  ...
  const BookmarkX = createLucideIcon("bookmark-x", __iconNode$lb);

  const __iconNode$la = [
    ["path", { d: "m19 21-7-4-7 4V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v16z", key: "1fy3hk" }]
  ];
  const Bookmark = createLucideIcon("bookmark", __iconNode$la);
  ...
  const BotMessageSquare = createLucideIcon("bot-message-square", __iconNode$l9);
  ...
  const BotOff = createLucideIcon("bot-off", __iconNode$l7);
  ...
  const Bot = createLucideIcon("bot", __iconNode$l6);
  ...
  const Box = createLucideIcon("box", __iconNode$l5);
  ...
  const Boxes = createLucideIcon("boxes", __iconNode$l4);
  ...
  const Brackets = createLucideIcon("brackets", __iconNode$l2);
  ...
  const BrainCircuit = createLucideIcon("brain-circuit", __iconNode$l1);
  ...
  const BrainCog = createLucideIcon("brain-cog", __iconNode$l0);
  ...
  const BrickWall = createLucideIcon("brick-wall", __iconNode$k_);
  ...
  const BriefcaseBusiness = createLucideIcon("briefcase-business", __iconNode$kZ);
  ...
  const BriefcaseMedical = createLucideIcon("briefcase-medical", __iconNode$kY);
  ...
  const BringToFront = createLucideIcon("bring-to-front", __iconNode$kV);
  ...
  const Brush = createLucideIcon("brush", __iconNode$kU);
  ...
  const BugOff = createLucideIcon("bug-off", __iconNode$kT);
  ...
  const BugPlay = createLucideIcon("bug-play", __iconNode$kS);
  ...
  const Bug = createLucideIcon("bug", __iconNode$kR);
  ...
  const Building2 = createLucideIcon("building-2", __iconNode$kQ);
  ...
  const Building = createLucideIcon("building", __iconNode$kP);
  ...
  const BusFront = createLucideIcon("bus-front", __iconNode$kO);
  ...
  const Bus = createLucideIcon("bus", __iconNode$kN);
  ...
  const CableCar = createLucideIcon("cable-car", __iconNode$kM);
  ...
  const Cable = createLucideIcon("cable", __iconNode$kL);
  ...
  const Cake = createLucideIcon("cake", __iconNode$kJ);
  ...
  const Calculator = createLucideIcon("calculator", __iconNode$kI);
  ...
  const Calendar1 = createLucideIcon("calendar-1", __iconNode$kH);
  ...
  const CalendarCheck2 = createLucideIcon("calendar-check-2", __iconNode$kE);
  ...
  const CalendarCheck = createLucideIcon("calendar-check", __iconNode$kD);
  ...
  const CalendarClock = createLucideIcon("calendar-clock", __iconNode$kC);
  ...
  const CalendarFold = createLucideIcon("calendar-fold", __iconNode$kz);
  ...
  const CalendarHeart = createLucideIcon("calendar-heart", __iconNode$ky);
  ...
  const CalendarMinus2 = createLucideIcon("calendar-minus-2", __iconNode$kx);
  ...
  const CalendarMinus = createLucideIcon("calendar-minus", __iconNode$kw);
  ...
  const CalendarOff = createLucideIcon("calendar-off", __iconNode$kv);
  ...
  const CalendarPlus2 = createLucideIcon("calendar-plus-2", __iconNode$ku);
  ...
  const CalendarPlus = createLucideIcon("calendar-plus", __iconNode$kt);
  ...
  const CalendarRange = createLucideIcon("calendar-range", __iconNode$ks);
  ...
  const CalendarSearch = createLucideIcon("calendar-search", __iconNode$kr);
  ...
  const CalendarSync = createLucideIcon("calendar-sync", __iconNode$kq);
  ...
  const CalendarX2 = createLucideIcon("calendar-x-2", __iconNode$kp);
  ...
  const CalendarX = createLucideIcon("calendar-x", __iconNode$ko);
  ...
  const Calendar = createLucideIcon("calendar", __iconNode$kn);
  ...
  const CameraOff = createLucideIcon("camera-off", __iconNode$km);
  ...
  const Camera = createLucideIcon("camera", __iconNode$kl);
  ...
  const CandyCane = createLucideIcon("candy-cane", __iconNode$kk);
  ...
  const CandyOff = createLucideIcon("candy-off", __iconNode$kj);
  ...
  const Candy = createLucideIcon("candy", __iconNode$ki);
  ...
  const Cannabis = createLucideIcon("cannabis", __iconNode$kh);
  ...
  const CaptionsOff = createLucideIcon("captions-off", __iconNode$kg);

  const __iconNode$kf = [
    ["rect", { width: "18", height: "14", x: "3", y: "5", rx: "2", ry: "2", key: "12ruh7" }],
    ["path", { d: "M7 15h4M15 15h2M7 11h2M13 11h4", key: "1ueiar" }]
  ];
  const Captions = createLucideIcon("captions", __iconNode$kf);
  ...
  const CarFront = createLucideIcon("car-front", __iconNode$ke);
  ...
  const CarTaxiFront = createLucideIcon("car-taxi-front", __iconNode$kd);
  ...
  const Car = createLucideIcon("car", __iconNode$kc);
  ...
  const Caravan = createLucideIcon("caravan", __iconNode$kb);
  ...
  const Carrot = createLucideIcon("carrot", __iconNode$ka);
  ...
  const CaseLower = createLucideIcon("case-lower", __iconNode$k9);
  ...
  const CaseSensitive = createLucideIcon("case-sensitive", __iconNode$k8);
  ...
  const CassetteTape = createLucideIcon("cassette-tape", __iconNode$k6);
  ...
  const Cast = createLucideIcon("cast", __iconNode$k5);
  ...
  const Castle = createLucideIcon("castle", __iconNode$k4);
  ...
  const Cat = createLucideIcon("cat", __iconNode$k3);
  ...
  const Cctv = createLucideIcon("cctv", __iconNode$k2);
  ...
  const ChartArea = createLucideIcon("chart-area", __iconNode$k1);
  ...
  const ChartBarBig = createLucideIcon("chart-bar-big", __iconNode$k0);
  ...
  const ChartBarIncreasing = createLucideIcon("chart-bar-increasing", __iconNode$j$);
  ...
  const ChartBarStacked = createLucideIcon("chart-bar-stacked", __iconNode$j_);
  ...
  const ChartBar = createLucideIcon("chart-bar", __iconNode$jY);
  ...
  const ChartCandlestick = createLucideIcon("chart-candlestick", __iconNode$jX);
  ...
  const ChartColumnBig = createLucideIcon("chart-column-big", __iconNode$jW);
  ...
  const ChartColumnIncreasing = createLucideIcon("chart-column-increasing", __iconNode$jU);
  ...
  const ChartColumnStacked = createLucideIcon("chart-column-stacked", __iconNode$jT);
  ...
  const ChartColumn = createLucideIcon("chart-column", __iconNode$jS);

  const __iconNode$jR = [
    ["path", { d: "M3 3v16a2 2 0 0 0 2 2h16", key: "c24i48" }],
    ["path", { d: "m19 9-5 5-4-4-3 3", key: "2osh9i" }]
  ];
  const ChartLine = createLucideIcon("chart-line", __iconNode$jR);
  ...
  const ChartNetwork = createLucideIcon("chart-network", __iconNode$jP);
  ...
  const ChartNoAxesColumnDecreasing = createLucideIcon("chart-no-axes-column-decreasing", __iconNode$jO);
  ...
  const ChartNoAxesColumnIncreasing = createLucideIcon("chart-no-axes-column-increasing", __iconNode$jN);
  ...
  const ChartNoAxesCombined = createLucideIcon("chart-no-axes-combined", __iconNode$jM);
  ...
  const ChartNoAxesGantt = createLucideIcon("chart-no-axes-gantt", __iconNode$jK);
  ...
  const ChartPie = createLucideIcon("chart-pie", __iconNode$jJ);
  ...
  const ChartScatter = createLucideIcon("chart-scatter", __iconNode$jI);

  const __iconNode$jH = [
    ["path", { d: "M3 3v16a2 2 0 0 0 2 2h16", key: "c24i48" }],
    ["path", { d: "M7 16c.5-2 1.5-7 4-7 2 0 2 3 4 3 2.5 0 4.5-5 5-7", key: "lw07rv" }]
  ];
  const ChartSpline = createLucideIcon("chart-spline", __iconNode$jH);

  const __iconNode$jG = [
    ["path", { d: "M18 6 7 17l-5-5", key: "116fxf" }],
    ["path", { d: "m22 10-7.5 7.5L13 16", key: "ke71qq" }]
  ];
  const CheckCheck = createLucideIcon("check-check", __iconNode$jG);

  const __iconNode$jF = [["path", { d: "M20 6 9 17l-5-5", key: "1gmf2c" }]];
  const Check = createLucideIcon("check", __iconNode$jF);
  ...
  const ChefHat = createLucideIcon("chef-hat", __iconNode$jE);
  ...
  const Cherry = createLucideIcon("cherry", __iconNode$jD);

  const __iconNode$jC = [["path", { d: "m6 9 6 6 6-6", key: "qrunsl" }]];
  const ChevronDown = createLucideIcon("chevron-down", __iconNode$jC);

  const __iconNode$jB = [
    ["path", { d: "m17 18-6-6 6-6", key: "1yerx2" }],
    ["path", { d: "M7 6v12", key: "1p53r6" }]
  ];
  const ChevronFirst = createLucideIcon("chevron-first", __iconNode$jB);

  const __iconNode$jA = [
    ["path", { d: "m7 18 6-6-6-6", key: "lwmzdw" }],
    ["path", { d: "M17 6v12", key: "1o0aio" }]
  ];
  const ChevronLast = createLucideIcon("chevron-last", __iconNode$jA);

  const __iconNode$jz = [["path", { d: "m15 18-6-6 6-6", key: "1wnfg3" }]];
  const ChevronLeft = createLucideIcon("chevron-left", __iconNode$jz);

  const __iconNode$jy = [["path", { d: "m9 18 6-6-6-6", key: "mthhwq" }]];
  const ChevronRight = createLucideIcon("chevron-right", __iconNode$jy);

  const __iconNode$jx = [["path", { d: "m18 15-6-6-6 6", key: "153udz" }]];
  const ChevronUp = createLucideIcon("chevron-up", __iconNode$jx);
  ...
  const ChevronsDown = createLucideIcon("chevrons-down", __iconNode$jv);
  ...
  const ChevronsLeftRightEllipsis = createLucideIcon("chevrons-left-right-ellipsis", __iconNode$ju);

  const __iconNode$jt = [
    ["path", { d: "m9 7-5 5 5 5", key: "j5w590" }],
    ["path", { d: "m15 7 5 5-5 5", key: "1bl6da" }]
  ];
  const ChevronsLeftRight = createLucideIcon("chevrons-left-right", __iconNode$jt);

  const __iconNode$js = [
    ["path", { d: "m11 17-5-5 5-5", key: "13zhaf" }],
    ["path", { d: "m18 17-5-5 5-5", key: "h8a8et" }]
  ];
  const ChevronsLeft = createLucideIcon("chevrons-left", __iconNode$js);

  const __iconNode$jr = [
    ["path", { d: "m20 17-5-5 5-5", key: "30x0n2" }],
    ["path", { d: "m4 17 5-5-5-5", key: "16spf4" }]
  ];
  const ChevronsRightLeft = createLucideIcon("chevrons-right-left", __iconNode$jr);

  const __iconNode$jq = [
    ["path", { d: "m6 17 5-5-5-5", key: "xnjwq" }],
    ["path", { d: "m13 17 5-5-5-5", key: "17xmmf" }]
  ];
  const ChevronsRight = createLucideIcon("chevrons-right", __iconNode$jq);

  const __iconNode$jp = [
    ["path", { d: "m7 15 5 5 5-5", key: "1hf1tw" }],
    ["path", { d: "m7 9 5-5 5 5", key: "sgt6xg" }]
  ];
  const ChevronsUpDown = createLucideIcon("chevrons-up-down", __iconNode$jp);

  const __iconNode$jo = [
    ["path", { d: "m17 11-5-5-5 5", key: "e8nh98" }],
    ["path", { d: "m17 18-5-5-5 5", key: "2avn1x" }]
  ];
  const ChevronsUp = createLucideIcon("chevrons-up", __iconNode$jo);
  ...
  const Chrome = createLucideIcon("chrome", __iconNode$jn);
  ...
  const Church = createLucideIcon("church", __iconNode$jm);
  ...
  const CigaretteOff = createLucideIcon("cigarette-off", __iconNode$jl);
  ...
  const Cigarette = createLucideIcon("cigarette", __iconNode$jk);
  ...
  const CircleAlert = createLucideIcon("circle-alert", __iconNode$jj);
  ...
  const CircleArrowDown = createLucideIcon("circle-arrow-down", __iconNode$ji);
  ...
  const CircleArrowLeft = createLucideIcon("circle-arrow-left", __iconNode$jh);
  ...
  const CircleArrowOutDownLeft = createLucideIcon("circle-arrow-out-down-left", __iconNode$jg);
  ...
  const CircleArrowOutDownRight = createLucideIcon("circle-arrow-out-down-right", __iconNode$jf);
  ...
  const CircleArrowOutUpLeft = createLucideIcon("circle-arrow-out-up-left", __iconNode$je);
  ...
  const CircleArrowOutUpRight = createLucideIcon("circle-arrow-out-up-right", __iconNode$jd);
  ...
  const CircleArrowRight = createLucideIcon("circle-arrow-right", __iconNode$jc);
  ...
  const CircleArrowUp = createLucideIcon("circle-arrow-up", __iconNode$jb);

  const __iconNode$ja = [
    ["path", { d: "M21.801 10A10 10 0 1 1 17 3.335", key: "yps3ct" }],
    ["path", { d: "m9 11 3 3L22 4", key: "1pflzl" }]
  ];
  const CircleCheckBig = createLucideIcon("circle-check-big", __iconNode$ja);

  const __iconNode$j9 = [
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
    ["path", { d: "m9 12 2 2 4-4", key: "dzmm74" }]
  ];
  const CircleCheck = createLucideIcon("circle-check", __iconNode$j9);

  const __iconNode$j8 = [
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
    ["path", { d: "m16 10-4 4-4-4", key: "894hmk" }]
  ];
  const CircleChevronDown = createLucideIcon("circle-chevron-down", __iconNode$j8);

  const __iconNode$j7 = [
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
    ["path", { d: "m14 16-4-4 4-4", key: "ojs7w8" }]
  ];
  const CircleChevronLeft = createLucideIcon("circle-chevron-left", __iconNode$j7);

  const __iconNode$j6 = [
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
    ["path", { d: "m10 8 4 4-4 4", key: "1wy4r4" }]
  ];
  const CircleChevronRight = createLucideIcon("circle-chevron-right", __iconNode$j6);

  const __iconNode$j5 = [
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
    ["path", { d: "m8 14 4-4 4 4", key: "fy2ptz" }]
  ];
  const CircleChevronUp = createLucideIcon("circle-chevron-up", __iconNode$j5);
  ...
  const CircleDollarSign = createLucideIcon("circle-dollar-sign", __iconNode$j2);
  ...
  const CircleDotDashed = createLucideIcon("circle-dot-dashed", __iconNode$j1);

  const __iconNode$j0 = [
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
    ["circle", { cx: "12", cy: "12", r: "1", key: "41hilf" }]
  ];
  const CircleDot = createLucideIcon("circle-dot", __iconNode$j0);
  ...
  const CircleEllipsis = createLucideIcon("circle-ellipsis", __iconNode$i$);
  ...
  const CircleEqual = createLucideIcon("circle-equal", __iconNode$i_);
  ...
  const CircleFadingArrowUp = createLucideIcon("circle-fading-arrow-up", __iconNode$iZ);
  ...
  const CircleFadingPlus = createLucideIcon("circle-fading-plus", __iconNode$iY);
  ...
  const CircleGauge = createLucideIcon("circle-gauge", __iconNode$iX);
  ...
  const CircleHelp = createLucideIcon("circle-help", __iconNode$iW);

  const __iconNode$iV = [
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
    ["path", { d: "M8 12h8", key: "1wcyev" }]
  ];
  const CircleMinus = createLucideIcon("circle-minus", __iconNode$iV);
  ...
  const CircleOff = createLucideIcon("circle-off", __iconNode$iU);
  ...
  const CircleParkingOff = createLucideIcon("circle-parking-off", __iconNode$iT);

  const __iconNode$iS = [
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
    ["path", { d: "M9 17V7h4a3 3 0 0 1 0 6H9", key: "1dfk2c" }]
  ];
  const CircleParking = createLucideIcon("circle-parking", __iconNode$iS);
  ...
  const CirclePause = createLucideIcon("circle-pause", __iconNode$iR);
  ...
  const CirclePlay = createLucideIcon("circle-play", __iconNode$iP);
  ...
  const CirclePlus = createLucideIcon("circle-plus", __iconNode$iO);
  ...
  const CirclePower = createLucideIcon("circle-power", __iconNode$iN);

  const __iconNode$iM = [
    ["path", { d: "M22 2 2 22", key: "y4kqgn" }],
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }]
  ];
  const CircleSlash2 = createLucideIcon("circle-slash-2", __iconNode$iM);

  const __iconNode$iL = [
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
    ["line", { x1: "9", x2: "15", y1: "15", y2: "9", key: "1dfufj" }]
  ];
  const CircleSlash = createLucideIcon("circle-slash", __iconNode$iL);

  const __iconNode$iK = [["circle", { cx: "12", cy: "12", r: "6", key: "1vlfrh" }]];
  const CircleSmall = createLucideIcon("circle-small", __iconNode$iK);

  const __iconNode$iJ = [
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
    ["rect", { x: "9", y: "9", width: "6", height: "6", rx: "1", key: "1ssd4o" }]
  ];
  const CircleStop = createLucideIcon("circle-stop", __iconNode$iJ);
  ...
  const CircleUserRound = createLucideIcon("circle-user-round", __iconNode$iI);
  ...
  const CircleUser = createLucideIcon("circle-user", __iconNode$iH);
  ...
  const __iconNode$iF = [["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }]];
  const Circle = createLucideIcon("circle", __iconNode$iF);
  ...
  const CircuitBoard = createLucideIcon("circuit-board", __iconNode$iE);
  ...
  const Citrus = createLucideIcon("citrus", __iconNode$iD);
  ...
  const Clapperboard = createLucideIcon("clapperboard", __iconNode$iC);
  ...
  const ClipboardCheck = createLucideIcon("clipboard-check", __iconNode$iB);
  ...
  const ClipboardCopy = createLucideIcon("clipboard-copy", __iconNode$iA);
  ...
  const ClipboardList = createLucideIcon("clipboard-list", __iconNode$iz);
  ...
  const ClipboardMinus = createLucideIcon("clipboard-minus", __iconNode$iy);
  ...
  const ClipboardPaste = createLucideIcon("clipboard-paste", __iconNode$ix);
  ...
  const ClipboardPenLine = createLucideIcon("clipboard-pen-line", __iconNode$iw);
  ...
  const ClipboardPen = createLucideIcon("clipboard-pen", __iconNode$iv);
  ...
  const ClipboardPlus = createLucideIcon("clipboard-plus", __iconNode$iu);
  ...
  const ClipboardType = createLucideIcon("clipboard-type", __iconNode$it);
  ...
  const ClipboardX = createLucideIcon("clipboard-x", __iconNode$is);
  ...
  const Clipboard = createLucideIcon("clipboard", __iconNode$ir);

  const __iconNode$iq = [
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
    ["polyline", { points: "12 6 12 12 14.5 8", key: "12zbmj" }]
  ];
  const Clock1 = createLucideIcon("clock-1", __iconNode$iq);

  const __iconNode$ip = [
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
    ["polyline", { points: "12 6 12 12 8 10", key: "atfzqc" }]
  ];
  const Clock10 = createLucideIcon("clock-10", __iconNode$ip);

  const __iconNode$io = [
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
    ["polyline", { points: "12 6 12 12 9.5 8", key: "l5bg6f" }]
  ];
  const Clock11 = createLucideIcon("clock-11", __iconNode$io);

  const __iconNode$in = [
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
    ["polyline", { points: "12 6 12 12", key: "1fub01" }]
  ];
  const Clock12 = createLucideIcon("clock-12", __iconNode$in);

  const __iconNode$im = [
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
    ["polyline", { points: "12 6 12 12 16 10", key: "1g230d" }]
  ];
  const Clock2 = createLucideIcon("clock-2", __iconNode$im);

  const __iconNode$il = [
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
    ["polyline", { points: "12 6 12 12 16.5 12", key: "1aq6pp" }]
  ];
  const Clock3 = createLucideIcon("clock-3", __iconNode$il);
  ...
  const Clock5 = createLucideIcon("clock-5", __iconNode$ij);

  const __iconNode$ii = [
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
    ["polyline", { points: "12 6 12 12 12 16.5", key: "hb2qv6" }]
  ];
  const Clock6 = createLucideIcon("clock-6", __iconNode$ii);

  const __iconNode$ih = [
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
    ["polyline", { points: "12 6 12 12 9.5 16", key: "ka3394" }]
  ];
  const Clock7 = createLucideIcon("clock-7", __iconNode$ih);
  ...
  const Clock9 = createLucideIcon("clock-9", __iconNode$if);
  ...
  const ClockAlert = createLucideIcon("clock-alert", __iconNode$ie);
  ...
  const ClockArrowDown = createLucideIcon("clock-arrow-down", __iconNode$id);
  ...
  const ClockArrowUp = createLucideIcon("clock-arrow-up", __iconNode$ic);
  ...
  const ClockFading = createLucideIcon("clock-fading", __iconNode$ib);

  const __iconNode$ia = [
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
    ["polyline", { points: "12 6 12 12 16 14", key: "68esgv" }]
  ];
  const Clock = createLucideIcon("clock", __iconNode$ia);
  ...
  const CloudAlert = createLucideIcon("cloud-alert", __iconNode$i9);
  ...
  const CloudCog = createLucideIcon("cloud-cog", __iconNode$i8);
  ...
  const CloudDownload = createLucideIcon("cloud-download", __iconNode$i7);
  ...
  const CloudDrizzle = createLucideIcon("cloud-drizzle", __iconNode$i6);
  ...
  const CloudFog = createLucideIcon("cloud-fog", __iconNode$i5);
  ...
  const CloudHail = createLucideIcon("cloud-hail", __iconNode$i4);

  const __iconNode$i3 = [
    ["path", { d: "M6 16.326A7 7 0 1 1 15.71 8h1.79a4.5 4.5 0 0 1 .5 8.973", key: "1cez44" }],
    ["path", { d: "m13 12-3 5h4l-3 5", key: "1t22er" }]
  ];
  const CloudLightning = createLucideIcon("cloud-lightning", __iconNode$i3);
  ...
  const CloudMoonRain = createLucideIcon("cloud-moon-rain", __iconNode$i2);

  const __iconNode$i1 = [
    ["path", { d: "M10.188 8.5A6 6 0 0 1 16 4a1 1 0 0 0 6 6 6 6 0 0 1-3 5.197", key: "erj67n" }],
    ["path", { d: "M13 16a3 3 0 1 1 0 6H7a5 5 0 1 1 4.9-6Z", key: "p44pc9" }]
  ];
  const CloudMoon = createLucideIcon("cloud-moon", __iconNode$i1);
  ...
  const CloudOff = createLucideIcon("cloud-off", __iconNode$i0);
  ...
  const CloudRainWind = createLucideIcon("cloud-rain-wind", __iconNode$h$);
  ...
  const CloudRain = createLucideIcon("cloud-rain", __iconNode$h_);
  ...
  const CloudSnow = createLucideIcon("cloud-snow", __iconNode$hZ);
  ...
  const CloudSunRain = createLucideIcon("cloud-sun-rain", __iconNode$hY);
  ...
  const CloudSun = createLucideIcon("cloud-sun", __iconNode$hX);
  ...
  const CloudUpload = createLucideIcon("cloud-upload", __iconNode$hW);

  const __iconNode$hV = [
    ["path", { d: "M17.5 19H9a7 7 0 1 1 6.71-9h1.79a4.5 4.5 0 1 1 0 9Z", key: "p7xjir" }]
  ];
  const Cloud = createLucideIcon("cloud", __iconNode$hV);
  ...
  const Cloudy = createLucideIcon("cloudy", __iconNode$hU);
  ...
  const Clover = createLucideIcon("clover", __iconNode$hT);
  ...
  const Club = createLucideIcon("club", __iconNode$hS);
  ...
  const CodeXml = createLucideIcon("code-xml", __iconNode$hR);

  const __iconNode$hQ = [
    ["polyline", { points: "16 18 22 12 16 6", key: "z7tu5w" }],
    ["polyline", { points: "8 6 2 12 8 18", key: "1eg1df" }]
  ];
  const Code = createLucideIcon("code", __iconNode$hQ);
  ...
  const Codepen = createLucideIcon("codepen", __iconNode$hP);
  ...
  const Codesandbox = createLucideIcon("codesandbox", __iconNode$hO);
  ...
  const Coffee = createLucideIcon("coffee", __iconNode$hN);
  ...
  const Cog = createLucideIcon("cog", __iconNode$hM);
  ...
  const Coins = createLucideIcon("coins", __iconNode$hL);

  const __iconNode$hK = [
    ["rect", { width: "18", height: "18", x: "3", y: "3", rx: "2", key: "afitv7" }],
    ["path", { d: "M12 3v18", key: "108xh3" }]
  ];
  const Columns2 = createLucideIcon("columns-2", __iconNode$hK);
  ...
  const Columns3 = createLucideIcon("columns-3", __iconNode$hJ);
  ...
  const Columns4 = createLucideIcon("columns-4", __iconNode$hI);
  ...
  const Combine = createLucideIcon("combine", __iconNode$hH);
  ...
  const Command = createLucideIcon("command", __iconNode$hG);
  ...
  const Compass = createLucideIcon("compass", __iconNode$hF);
  ...
  const ConciergeBell = createLucideIcon("concierge-bell", __iconNode$hC);

  const __iconNode$hB = [
    ["path", { d: "m20.9 18.55-8-15.98a1 1 0 0 0-1.8 0l-8 15.98", key: "53pte7" }],
    ["ellipse", { cx: "12", cy: "19", rx: "9", ry: "3", key: "1ji25f" }]
  ];
  const Cone = createLucideIcon("cone", __iconNode$hB);
  ...
  const Construction = createLucideIcon("construction", __iconNode$hA);
  ...
  const ContactRound = createLucideIcon("contact-round", __iconNode$hz);
  ...
  const Contact = createLucideIcon("contact", __iconNode$hy);
  ...
  const Container = createLucideIcon("container", __iconNode$hx);

  const __iconNode$hw = [
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
    ["path", { d: "M12 18a6 6 0 0 0 0-12v12z", key: "j4l70d" }]
  ];
  const Contrast = createLucideIcon("contrast", __iconNode$hw);
  ...
  const Cookie = createLucideIcon("cookie", __iconNode$hv);
  ...
  const CookingPot = createLucideIcon("cooking-pot", __iconNode$hu);
  ...
  const CopyCheck = createLucideIcon("copy-check", __iconNode$ht);
  ...
  const CopyMinus = createLucideIcon("copy-minus", __iconNode$hs);
  ...
  const CopyPlus = createLucideIcon("copy-plus", __iconNode$hr);
  ...
  const CopySlash = createLucideIcon("copy-slash", __iconNode$hq);
  ...
  const CopyX = createLucideIcon("copy-x", __iconNode$hp);

  const __iconNode$ho = [
    ["rect", { width: "14", height: "14", x: "8", y: "8", rx: "2", ry: "2", key: "17jyea" }],
    ["path", { d: "M4 16c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2h10c1.1 0 2 .9 2 2", key: "zix9uf" }]
  ];
  const Copy = createLucideIcon("copy", __iconNode$ho);

  const __iconNode$hn = [
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
    ["path", { d: "M9.17 14.83a4 4 0 1 0 0-5.66", key: "1sveal" }]
  ];
  const Copyleft = createLucideIcon("copyleft", __iconNode$hn);

  const __iconNode$hm = [
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
    ["path", { d: "M14.83 14.83a4 4 0 1 1 0-5.66", key: "1i56pz" }]
  ];
  const Copyright = createLucideIcon("copyright", __iconNode$hm);

  const __iconNode$hl = [
    ["polyline", { points: "9 10 4 15 9 20", key: "r3jprv" }],
    ["path", { d: "M20 4v7a4 4 0 0 1-4 4H4", key: "6o5b7l" }]
  ];
  const CornerDownLeft = createLucideIcon("corner-down-left", __iconNode$hl);

  const __iconNode$hk = [
    ["polyline", { points: "15 10 20 15 15 20", key: "1q7qjw" }],
    ["path", { d: "M4 4v7a4 4 0 0 0 4 4h12", key: "z08zvw" }]
  ];
  const CornerDownRight = createLucideIcon("corner-down-right", __iconNode$hk);
  ...
  const CornerLeftUp = createLucideIcon("corner-left-up", __iconNode$hi);
  ...
  const CornerUpLeft = createLucideIcon("corner-up-left", __iconNode$hf);

  const __iconNode$he = [
    ["polyline", { points: "15 14 20 9 15 4", key: "1tbx3s" }],
    ["path", { d: "M4 20v-7a4 4 0 0 1 4-4h12", key: "1lu4f8" }]
  ];
  const CornerUpRight = createLucideIcon("corner-up-right", __iconNode$he);
  ...
  const Cpu = createLucideIcon("cpu", __iconNode$hd);
  ...
  const CreativeCommons = createLucideIcon("creative-commons", __iconNode$hc);
  ...
  const Croissant = createLucideIcon("croissant", __iconNode$ha);

  const __iconNode$h9 = [
    ["path", { d: "M6 2v14a2 2 0 0 0 2 2h14", key: "ron5a4" }],
    ["path", { d: "M18 22V8a2 2 0 0 0-2-2H2", key: "7s9ehn" }]
  ];
  const Crop = createLucideIcon("crop", __iconNode$h9);
  ...
  const Cross = createLucideIcon("cross", __iconNode$h8);
  ...
  const Cuboid = createLucideIcon("cuboid", __iconNode$h5);
  ...
  const CupSoda = createLucideIcon("cup-soda", __iconNode$h4);
  ...
  const Currency = createLucideIcon("currency", __iconNode$h3);

  const __iconNode$h2 = [
    ["ellipse", { cx: "12", cy: "5", rx: "9", ry: "3", key: "msslwz" }],
    ["path", { d: "M3 5v14a9 3 0 0 0 18 0V5", key: "aqi0yr" }]
  ];
  const Cylinder = createLucideIcon("cylinder", __iconNode$h2);
  ...
  const Dam = createLucideIcon("dam", __iconNode$h1);
  ...
  const DatabaseBackup = createLucideIcon("database-backup", __iconNode$h0);
  ...
  const DatabaseZap = createLucideIcon("database-zap", __iconNode$g$);
  ...
  const Database = createLucideIcon("database", __iconNode$g_);
  ...
  const Delete = createLucideIcon("delete", __iconNode$gZ);
  ...
  const Dessert = createLucideIcon("dessert", __iconNode$gY);
  ...
  const Diameter = createLucideIcon("diameter", __iconNode$gX);
  ...
  const DiamondMinus = createLucideIcon("diamond-minus", __iconNode$gW);
  ...
  const DiamondPercent = createLucideIcon("diamond-percent", __iconNode$gV);
  ...
  const DiamondPlus = createLucideIcon("diamond-plus", __iconNode$gU);
  ...
  const Diamond = createLucideIcon("diamond", __iconNode$gT);
  ...
  const Dice2 = createLucideIcon("dice-2", __iconNode$gR);
  ...
  const Dice3 = createLucideIcon("dice-3", __iconNode$gQ);
  ...
  const Dice4 = createLucideIcon("dice-4", __iconNode$gP);
  ...
  const Dice5 = createLucideIcon("dice-5", __iconNode$gO);
  ...
  const Dice6 = createLucideIcon("dice-6", __iconNode$gN);
  ...
  const Dices = createLucideIcon("dices", __iconNode$gM);
  ...
  const Diff = createLucideIcon("diff", __iconNode$gL);
  ...
  const Disc2 = createLucideIcon("disc-2", __iconNode$gK);
  ...
  const Disc3 = createLucideIcon("disc-3", __iconNode$gJ);
  ...
  const DiscAlbum = createLucideIcon("disc-album", __iconNode$gI);

  const __iconNode$gH = [
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
    ["circle", { cx: "12", cy: "12", r: "2", key: "1c9p78" }]
  ];
  const Disc = createLucideIcon("disc", __iconNode$gH);
  ...
  const Divide = createLucideIcon("divide", __iconNode$gG);
  ...
  const DnaOff = createLucideIcon("dna-off", __iconNode$gF);
  ...
  const Dna = createLucideIcon("dna", __iconNode$gE);
  ...
  const Dock = createLucideIcon("dock", __iconNode$gD);
  ...
  const Dog = createLucideIcon("dog", __iconNode$gC);

  const __iconNode$gB = [
    ["line", { x1: "12", x2: "12", y1: "2", y2: "22", key: "7eqyqh" }],
    ["path", { d: "M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6", key: "1b0p4s" }]
  ];
  const DollarSign = createLucideIcon("dollar-sign", __iconNode$gB);
  ...
  const Donut = createLucideIcon("donut", __iconNode$gA);
  ...
  const DoorClosed = createLucideIcon("door-closed", __iconNode$gz);
  ...
  const DoorOpen = createLucideIcon("door-open", __iconNode$gy);

  const __iconNode$gx = [["circle", { cx: "12.1", cy: "12.1", r: "1", key: "18d7e5" }]];
  const Dot = createLucideIcon("dot", __iconNode$gx);
  ...
  const Download = createLucideIcon("download", __iconNode$gw);
  ...
  const DraftingCompass = createLucideIcon("drafting-compass", __iconNode$gv);
  ...
  const Drama = createLucideIcon("drama", __iconNode$gu);
  ...
  const Dribbble = createLucideIcon("dribbble", __iconNode$gt);
  ...
  const Drill = createLucideIcon("drill", __iconNode$gs);
  ...
  const Dumbbell = createLucideIcon("dumbbell", __iconNode$gm);
  ...
  const Earth = createLucideIcon("earth", __iconNode$gi);

  const __iconNode$gh = [
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
    ["path", { d: "M12 2a7 7 0 1 0 10 10", key: "1yuj32" }]
  ];
  const Eclipse = createLucideIcon("eclipse", __iconNode$gh);
  ...
  const Equal = createLucideIcon("equal", __iconNode$g9);
  ...
  const Eraser = createLucideIcon("eraser", __iconNode$g8);
  ...
  const EthernetPort = createLucideIcon("ethernet-port", __iconNode$g7);
  ...
  const Euro = createLucideIcon("euro", __iconNode$g6);
  ...
  const Expand = createLucideIcon("expand", __iconNode$g5);
  ...
  const ExternalLink = createLucideIcon("external-link", __iconNode$g4);
  ...
  const EyeClosed = createLucideIcon("eye-closed", __iconNode$g3);
  ...
  const EyeOff = createLucideIcon("eye-off", __iconNode$g2);
  ...
  const Eye = createLucideIcon("eye", __iconNode$g1);
  ...
  const Facebook = createLucideIcon("facebook", __iconNode$g0);
  ...
  const FastForward = createLucideIcon("fast-forward", __iconNode$fZ);
  ...
  const Feather = createLucideIcon("feather", __iconNode$fY);
  ...
  const FerrisWheel = createLucideIcon("ferris-wheel", __iconNode$fW);
  ...
  const Figma = createLucideIcon("figma", __iconNode$fV);
  ...
  const FileArchive = createLucideIcon("file-archive", __iconNode$fU);
  ...
  const FileAudio2 = createLucideIcon("file-audio-2", __iconNode$fT);
  ...
  const FileAudio = createLucideIcon("file-audio", __iconNode$fS);
  ...
  const FileAxis3d = createLucideIcon("file-axis-3d", __iconNode$fR);
  ...
  const FileBadge2 = createLucideIcon("file-badge-2", __iconNode$fQ);
  ...
  const FileBadge = createLucideIcon("file-badge", __iconNode$fP);
  ...
  const FileBox = createLucideIcon("file-box", __iconNode$fO);
  ...
  const FileChartColumnIncreasing = createLucideIcon("file-chart-column-increasing", __iconNode$fN);
  ...
  const FileChartColumn = createLucideIcon("file-chart-column", __iconNode$fM);
  ...
  const FileChartLine = createLucideIcon("file-chart-line", __iconNode$fL);
  ...
  const FileChartPie = createLucideIcon("file-chart-pie", __iconNode$fK);
  ...
  const FileCheck2 = createLucideIcon("file-check-2", __iconNode$fJ);
  ...
  const FileCheck = createLucideIcon("file-check", __iconNode$fI);
  ...
  const FileCode2 = createLucideIcon("file-code-2", __iconNode$fG);
  ...
  const FileCode = createLucideIcon("file-code", __iconNode$fF);
  ...
  const FileCog = createLucideIcon("file-cog", __iconNode$fE);
  ...
  const FileDiff = createLucideIcon("file-diff", __iconNode$fD);
  ...
  const FileDigit = createLucideIcon("file-digit", __iconNode$fC);
  ...
  const FileDown = createLucideIcon("file-down", __iconNode$fB);
  ...
  const FileHeart = createLucideIcon("file-heart", __iconNode$fA);
  ...
  const FileMusic = createLucideIcon("file-music", __iconNode$fp);
  ...
  const FileOutput = createLucideIcon("file-output", __iconNode$fo);
  ...
  const FileQuestion = createLucideIcon("file-question", __iconNode$fj);
  ...
  const FileType2 = createLucideIcon("file-type-2", __iconNode$f9);
  ...
  const FileType = createLucideIcon("file-type", __iconNode$f8);
  ...
  const FileUp = createLucideIcon("file-up", __iconNode$f7);
  ...
  const FileUser = createLucideIcon("file-user", __iconNode$f6);
  ...
  const FileVideo2 = createLucideIcon("file-video-2", __iconNode$f5);
  ...
  const FileVideo = createLucideIcon("file-video", __iconNode$f4);
  ...
  const FileVolume2 = createLucideIcon("file-volume-2", __iconNode$f3);
  ...
  const FileVolume = createLucideIcon("file-volume", __iconNode$f2);
  ...
  const FileWarning = createLucideIcon("file-warning", __iconNode$f1);
  ...
  const FileX2 = createLucideIcon("file-x-2", __iconNode$f0);
  ...
  const FileX = createLucideIcon("file-x", __iconNode$e$);

  const __iconNode$e_ = [
    ["path", { d: "M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z", key: "1rqfz7" }],
    ["path", { d: "M14 2v4a2 2 0 0 0 2 2h4", key: "tnqrlb" }]
  ];
  const File = createLucideIcon("file", __iconNode$e_);
  ...
  const Files = createLucideIcon("files", __iconNode$eZ);
  ...
  const Film = createLucideIcon("film", __iconNode$eY);
  ...
  const Fingerprint = createLucideIcon("fingerprint", __iconNode$eX);
  ...
  const FireExtinguisher = createLucideIcon("fire-extinguisher", __iconNode$eW);
  ...
  const FishOff = createLucideIcon("fish-off", __iconNode$eV);

  const __iconNode$eU = [
    ["path", { d: "M2 16s9-15 20-4C11 23 2 8 2 8", key: "h4oh4o" }]
  ];
  const FishSymbol = createLucideIcon("fish-symbol", __iconNode$eU);
  ...
  const Fish = createLucideIcon("fish", __iconNode$eT);
  ...
  const __iconNode$eR = [["path", { d: "M17 22V2L7 7l10 5", key: "1rmf0r" }]];
  const FlagTriangleLeft = createLucideIcon("flag-triangle-left", __iconNode$eR);

  const __iconNode$eQ = [["path", { d: "M7 22V2l10 5-10 5", key: "17n18y" }]];
  const FlagTriangleRight = createLucideIcon("flag-triangle-right", __iconNode$eQ);

  const __iconNode$eP = [
    ["path", { d: "M4 15s1-1 4-1 5 2 8 2 4-1 4-1V3s-1 1-4 1-5-2-8-2-4 1-4 1z", key: "i9b6wo" }],
    ["line", { x1: "4", x2: "4", y1: "22", y2: "15", key: "1cm3nv" }]
  ];
  const Flag = createLucideIcon("flag", __iconNode$eP);
  ...
  const FlameKindling = createLucideIcon("flame-kindling", __iconNode$eO);
  ...
  const Flame = createLucideIcon("flame", __iconNode$eN);
  ...
  const FlashlightOff = createLucideIcon("flashlight-off", __iconNode$eM);
  ...
  const Flashlight = createLucideIcon("flashlight", __iconNode$eL);
  ...
  const FlaskConicalOff = createLucideIcon("flask-conical-off", __iconNode$eK);
  ...
  const FlaskConical = createLucideIcon("flask-conical", __iconNode$eJ);
  ...
  const FlaskRound = createLucideIcon("flask-round", __iconNode$eI);
  ...
  const FlipHorizontal2 = createLucideIcon("flip-horizontal-2", __iconNode$eH);
  ...
  const FlipVertical2 = createLucideIcon("flip-vertical-2", __iconNode$eF);
  ...
  const FlipVertical = createLucideIcon("flip-vertical", __iconNode$eE);
  ...
  const Flower2 = createLucideIcon("flower-2", __iconNode$eD);
  ...
  const Flower = createLucideIcon("flower", __iconNode$eC);
  ...
  const Focus = createLucideIcon("focus", __iconNode$eB);
  ...
  const FoldHorizontal = createLucideIcon("fold-horizontal", __iconNode$eA);
  ...
  const FoldVertical = createLucideIcon("fold-vertical", __iconNode$ez);
  ...
  const FolderArchive = createLucideIcon("folder-archive", __iconNode$ey);
  ...
  const FolderCode = createLucideIcon("folder-code", __iconNode$eu);
  ...
  const FolderCog = createLucideIcon("folder-cog", __iconNode$et);
  ...
  const FolderSync = createLucideIcon("folder-sync", __iconNode$e9);
  ...
  const FolderTree = createLucideIcon("folder-tree", __iconNode$e8);
  ...
  const FolderUp = createLucideIcon("folder-up", __iconNode$e7);
  ...
  const FolderX = createLucideIcon("folder-x", __iconNode$e6);
  ...
  const Folder = createLucideIcon("folder", __iconNode$e5);
  ...
  const Folders = createLucideIcon("folders", __iconNode$e4);
  ...
  const Footprints = createLucideIcon("footprints", __iconNode$e3);
  ...
  const Forklift = createLucideIcon("forklift", __iconNode$e2);

  const __iconNode$e1 = [
    ["polyline", { points: "15 17 20 12 15 7", key: "1w3sku" }],
    ["path", { d: "M4 18v-2a4 4 0 0 1 4-4h12", key: "jmiej9" }]
  ];
  const Forward = createLucideIcon("forward", __iconNode$e1);
  ...
  const Frame = createLucideIcon("frame", __iconNode$e0);

  const __iconNode$d$ = [
    ["path", { d: "M5 16V9h14V2H5l14 14h-7m-7 0 7 7v-7m-7 0h7", key: "1a2nng" }]
  ];
  const Framer = createLucideIcon("framer", __iconNode$d$);
  ...
  const Frown = createLucideIcon("frown", __iconNode$d_);
  ...
  const Fuel = createLucideIcon("fuel", __iconNode$dZ);
  ...
  const Fullscreen = createLucideIcon("fullscreen", __iconNode$dY);
  ...
  const FunnelPlus = createLucideIcon("funnel-plus", __iconNode$dX);
  ...
  const FunnelX = createLucideIcon("funnel-x", __iconNode$dW);
  ...
  const Funnel = createLucideIcon("funnel", __iconNode$dV);
  ...
  const GalleryHorizontalEnd = createLucideIcon("gallery-horizontal-end", __iconNode$dU);
  ...
  const GalleryHorizontal = createLucideIcon("gallery-horizontal", __iconNode$dT);
  ...
  const GalleryThumbnails = createLucideIcon("gallery-thumbnails", __iconNode$dS);
  ...
  const GalleryVerticalEnd = createLucideIcon("gallery-vertical-end", __iconNode$dR);
  ...
  const GalleryVertical = createLucideIcon("gallery-vertical", __iconNode$dQ);
  ...
  const Gamepad2 = createLucideIcon("gamepad-2", __iconNode$dP);
  ...
  const Gamepad = createLucideIcon("gamepad", __iconNode$dO);

  const __iconNode$dN = [
    ["path", { d: "m12 14 4-4", key: "9kzdfg" }],
    ["path", { d: "M3.34 19a10 10 0 1 1 17.32 0", key: "19p75a" }]
  ];
  const Gauge = createLucideIcon("gauge", __iconNode$dN);
  ...
  const Gavel = createLucideIcon("gavel", __iconNode$dM);
  ...
  const Gem = createLucideIcon("gem", __iconNode$dL);
  ...
  const Ghost = createLucideIcon("ghost", __iconNode$dK);
  ...
  const Gift = createLucideIcon("gift", __iconNode$dJ);
  ...
  const GitBranchPlus = createLucideIcon("git-branch-plus", __iconNode$dI);
  ...
  const GitBranch = createLucideIcon("git-branch", __iconNode$dH);
  ...
  const GitCommitHorizontal = createLucideIcon("git-commit-horizontal", __iconNode$dG);
  ...
  const GitCommitVertical = createLucideIcon("git-commit-vertical", __iconNode$dF);
  ...
  const GitCompareArrows = createLucideIcon("git-compare-arrows", __iconNode$dE);
  ...
  const GitCompare = createLucideIcon("git-compare", __iconNode$dD);
  ...
  const GitFork = createLucideIcon("git-fork", __iconNode$dC);
  ...
  const GitGraph = createLucideIcon("git-graph", __iconNode$dB);
  ...
  const GitMerge = createLucideIcon("git-merge", __iconNode$dA);
  ...
  const GitPullRequestArrow = createLucideIcon("git-pull-request-arrow", __iconNode$dz);
  ...
  const GitPullRequestClosed = createLucideIcon("git-pull-request-closed", __iconNode$dy);
  ...
  const GitPullRequestCreateArrow = createLucideIcon("git-pull-request-create-arrow", __iconNode$dx);
  ...
  const GitPullRequestCreate = createLucideIcon("git-pull-request-create", __iconNode$dw);
  ...
  const GitPullRequest = createLucideIcon("git-pull-request", __iconNode$du);
  ...
  const Github = createLucideIcon("github", __iconNode$dt);
  ...
  const Gitlab = createLucideIcon("gitlab", __iconNode$ds);
  ...
  const GlassWater = createLucideIcon("glass-water", __iconNode$dr);
  ...
  const GlobeLock = createLucideIcon("globe-lock", __iconNode$dp);
  ...
  const Globe = createLucideIcon("globe", __iconNode$do);
  ...
  const Goal = createLucideIcon("goal", __iconNode$dn);
  ...
  const Grid3x3 = createLucideIcon("grid-3x3", __iconNode$df);
  ...
  const GripVertical = createLucideIcon("grip-vertical", __iconNode$dd);
  ...
  const Grip = createLucideIcon("grip", __iconNode$dc);
  ...
  const Group = createLucideIcon("group", __iconNode$db);
  ...
  const Ham = createLucideIcon("ham", __iconNode$d9);
  ...
  const Hammer = createLucideIcon("hammer", __iconNode$d8);
  ...
  const HandCoins = createLucideIcon("hand-coins", __iconNode$d7);
  ...
  const HandHeart = createLucideIcon("hand-heart", __iconNode$d6);
  ...
  const HandHelping = createLucideIcon("hand-helping", __iconNode$d5);
  ...
  const HandMetal = createLucideIcon("hand-metal", __iconNode$d4);
  ...
  const HandPlatter = createLucideIcon("hand-platter", __iconNode$d3);
  ...
  const Hand = createLucideIcon("hand", __iconNode$d2);
  ...
  const Handshake = createLucideIcon("handshake", __iconNode$d1);
  ...
  const HardDriveDownload = createLucideIcon("hard-drive-download", __iconNode$d0);
  ...
  const HardDriveUpload = createLucideIcon("hard-drive-upload", __iconNode$c$);
  ...
  const HardDrive = createLucideIcon("hard-drive", __iconNode$c_);
  ...
  const HardHat = createLucideIcon("hard-hat", __iconNode$cZ);
  ...
  const Hash = createLucideIcon("hash", __iconNode$cY);
  ...
  const Haze = createLucideIcon("haze", __iconNode$cX);
  ...
  const HdmiPort = createLucideIcon("hdmi-port", __iconNode$cW);
  ...
  const Heading1 = createLucideIcon("heading-1", __iconNode$cV);
  ...
  const Heading2 = createLucideIcon("heading-2", __iconNode$cU);
  ...
  const Heading3 = createLucideIcon("heading-3", __iconNode$cT);
  ...
  const Heading4 = createLucideIcon("heading-4", __iconNode$cS);
  ...
  const Heading5 = createLucideIcon("heading-5", __iconNode$cR);
  ...
  const Heading6 = createLucideIcon("heading-6", __iconNode$cQ);
  ...
  const Heading = createLucideIcon("heading", __iconNode$cP);
  ...
  const HeadphoneOff = createLucideIcon("headphone-off", __iconNode$cO);
  ...
  const Headphones = createLucideIcon("headphones", __iconNode$cN);
  ...
  const Headset = createLucideIcon("headset", __iconNode$cM);
  ...
  const HeartCrack = createLucideIcon("heart-crack", __iconNode$cL);
  ...
  const HeartHandshake = createLucideIcon("heart-handshake", __iconNode$cK);
  ...
  const HeartOff = createLucideIcon("heart-off", __iconNode$cJ);
  ...
  const HeartPulse = createLucideIcon("heart-pulse", __iconNode$cI);
  ...
  const Heart = createLucideIcon("heart", __iconNode$cH);
  ...
  const Heater = createLucideIcon("heater", __iconNode$cG);
  ...
  const HopOff = createLucideIcon("hop-off", __iconNode$cC);
  ...
  const Hop = createLucideIcon("hop", __iconNode$cB);
  ...
  const Hospital = createLucideIcon("hospital", __iconNode$cA);
  ...
  const Hotel = createLucideIcon("hotel", __iconNode$cz);
  ...
  const Hourglass = createLucideIcon("hourglass", __iconNode$cy);
  ...
  const HousePlug = createLucideIcon("house-plug", __iconNode$cx);
  ...
  const HousePlus = createLucideIcon("house-plus", __iconNode$cw);
  ...
  const HouseWifi = createLucideIcon("house-wifi", __iconNode$cv);
  ...
  const IceCreamBowl = createLucideIcon("ice-cream-bowl", __iconNode$ct);
  ...
  const IceCreamCone = createLucideIcon("ice-cream-cone", __iconNode$cs);
  ...
  const IdCard = createLucideIcon("id-card", __iconNode$cr);
  ...
  const ImageDown = createLucideIcon("image-down", __iconNode$cq);
  ...
  const ImageMinus = createLucideIcon("image-minus", __iconNode$cp);
  ...
  const ImageOff = createLucideIcon("image-off", __iconNode$co);
  ...
  const ImagePlay = createLucideIcon("image-play", __iconNode$cn);
  ...
  const ImagePlus = createLucideIcon("image-plus", __iconNode$cm);
  ...
  const ImageUp = createLucideIcon("image-up", __iconNode$cl);
  ...
  const ImageUpscale = createLucideIcon("image-upscale", __iconNode$ck);
  ...
  const Image = createLucideIcon("image", __iconNode$cj);
  ...
  const Images = createLucideIcon("images", __iconNode$ci);
  ...
  const Import = createLucideIcon("import", __iconNode$ch);
  ...
  const Inbox = createLucideIcon("inbox", __iconNode$cg);
  ...
  const IndentDecrease = createLucideIcon("indent-decrease", __iconNode$cf);
  ...
  const IndentIncrease = createLucideIcon("indent-increase", __iconNode$ce);
  ...
  const IndianRupee = createLucideIcon("indian-rupee", __iconNode$cd);

  const __iconNode$cc = [
    ["path", { d: "M6 16c5 0 7-8 12-8a4 4 0 0 1 0 8c-5 0-7-8-12-8a4 4 0 1 0 0 8", key: "18ogeb" }]
  ];
  const Infinity = createLucideIcon("infinity", __iconNode$cc);
  ...
  const Info = createLucideIcon("info", __iconNode$cb);
  ...
  const InspectionPanel = createLucideIcon("inspection-panel", __iconNode$ca);
  ...
  const Instagram = createLucideIcon("instagram", __iconNode$c9);
  ...
  const JapaneseYen = createLucideIcon("japanese-yen", __iconNode$c5);
  ...
  const Joystick = createLucideIcon("joystick", __iconNode$c4);
  ...
  const Kanban = createLucideIcon("kanban", __iconNode$c3);
  ...
  const KeyRound = createLucideIcon("key-round", __iconNode$c2);
  ...
  const KeySquare = createLucideIcon("key-square", __iconNode$c1);
  ...
  const Key = createLucideIcon("key", __iconNode$c0);
  ...
  const KeyboardMusic = createLucideIcon("keyboard-music", __iconNode$b$);
  ...
  const KeyboardOff = createLucideIcon("keyboard-off", __iconNode$b_);
  ...
  const Keyboard = createLucideIcon("keyboard", __iconNode$bZ);
  ...
  const LampCeiling = createLucideIcon("lamp-ceiling", __iconNode$bY);
  ...
  const LampDesk = createLucideIcon("lamp-desk", __iconNode$bX);
  ...
  const LampFloor = createLucideIcon("lamp-floor", __iconNode$bW);
  ...
  const LampWallDown = createLucideIcon("lamp-wall-down", __iconNode$bV);
  ...
  const LandPlot = createLucideIcon("land-plot", __iconNode$bS);
  ...
  const Landmark = createLucideIcon("landmark", __iconNode$bR);
  ...
  const Languages = createLucideIcon("languages", __iconNode$bQ);
  ...
  const LaptopMinimalCheck = createLucideIcon("laptop-minimal-check", __iconNode$bP);

  const __iconNode$bO = [
    ["rect", { width: "18", height: "12", x: "3", y: "4", rx: "2", ry: "2", key: "1qhy41" }],
    ["line", { x1: "2", x2: "22", y1: "20", y2: "20", key: "ni3hll" }]
  ];
  const LaptopMinimal = createLucideIcon("laptop-minimal", __iconNode$bO);
  ...
  const Laptop = createLucideIcon("laptop", __iconNode$bN);
  ...
  const LassoSelect = createLucideIcon("lasso-select", __iconNode$bM);
  ...
  const Lasso = createLucideIcon("lasso", __iconNode$bL);
  ...
  const Laugh = createLucideIcon("laugh", __iconNode$bK);
  ...
  const LayoutDashboard = createLucideIcon("layout-dashboard", __iconNode$bH);
  ...
  const LayoutGrid = createLucideIcon("layout-grid", __iconNode$bG);
  ...
  const LayoutList = createLucideIcon("layout-list", __iconNode$bF);
  ...
  const LayoutPanelLeft = createLucideIcon("layout-panel-left", __iconNode$bE);
  ...
  const LayoutPanelTop = createLucideIcon("layout-panel-top", __iconNode$bD);
  ...
  const LayoutTemplate = createLucideIcon("layout-template", __iconNode$bC);
  ...
  const Leaf = createLucideIcon("leaf", __iconNode$bB);
  ...
  const LeafyGreen = createLucideIcon("leafy-green", __iconNode$bA);
  ...
  const Lectern = createLucideIcon("lectern", __iconNode$bz);
  ...
  const LetterText = createLucideIcon("letter-text", __iconNode$by);
  ...
  const LibraryBig = createLucideIcon("library-big", __iconNode$bx);
  ...
  const Library = createLucideIcon("library", __iconNode$bw);
  ...
  const LifeBuoy = createLucideIcon("life-buoy", __iconNode$bv);
  ...
  const Ligature = createLucideIcon("ligature", __iconNode$bu);
  ...
  const LightbulbOff = createLucideIcon("lightbulb-off", __iconNode$bt);
  ...
  const Lightbulb = createLucideIcon("lightbulb", __iconNode$bs);
  ...
  const Link2Off = createLucideIcon("link-2-off", __iconNode$br);
  ...
  const Link2 = createLucideIcon("link-2", __iconNode$bq);

  const __iconNode$bp = [
    ["path", { d: "M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71", key: "1cjeqo" }],
    ["path", { d: "M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71", key: "19qd67" }]
  ];
  const Link = createLucideIcon("link", __iconNode$bp);
  ...
  const Linkedin = createLucideIcon("linkedin", __iconNode$bo);
  ...
  const ListCheck = createLucideIcon("list-check", __iconNode$bn);
  ...
  const ListCollapse = createLucideIcon("list-collapse", __iconNode$bm);
  ...
  const ListFilterPlus = createLucideIcon("list-filter-plus", __iconNode$bj);
  ...
  const ListFilter = createLucideIcon("list-filter", __iconNode$bi);
  ...
  const ListMinus = createLucideIcon("list-minus", __iconNode$bh);
  ...
  const ListMusic = createLucideIcon("list-music", __iconNode$bg);
  ...
  const ListOrdered = createLucideIcon("list-ordered", __iconNode$bf);
  ...
  const ListPlus = createLucideIcon("list-plus", __iconNode$be);
  ...
  const ListRestart = createLucideIcon("list-restart", __iconNode$bd);
  ...
  const ListStart = createLucideIcon("list-start", __iconNode$bc);
  ...
  const ListTodo = createLucideIcon("list-todo", __iconNode$bb);
  ...
  const ListTree = createLucideIcon("list-tree", __iconNode$ba);
  ...
  const ListVideo = createLucideIcon("list-video", __iconNode$b9);
  ...
  const ListX = createLucideIcon("list-x", __iconNode$b8);
  ...
  const List = createLucideIcon("list", __iconNode$b7);

  const __iconNode$b6 = [["path", { d: "M21 12a9 9 0 1 1-6.219-8.56", key: "13zald" }]];
  const LoaderCircle = createLucideIcon("loader-circle", __iconNode$b6);
  ...
  const LoaderPinwheel = createLucideIcon("loader-pinwheel", __iconNode$b5);
  ...
  const Loader = createLucideIcon("loader", __iconNode$b4);
  ...
  const Locate = createLucideIcon("locate", __iconNode$b2);
  ...
  const LockKeyholeOpen = createLucideIcon("lock-keyhole-open", __iconNode$b0);
  ...
  const LockOpen = createLucideIcon("lock-open", __iconNode$a_);

  const __iconNode$aZ = [
    ["rect", { width: "18", height: "11", x: "3", y: "11", rx: "2", ry: "2", key: "1w4ew1" }],
    ["path", { d: "M7 11V7a5 5 0 0 1 10 0v4", key: "fwvmzm" }]
  ];
  const Lock = createLucideIcon("lock", __iconNode$aZ);
  ...
  const LogIn = createLucideIcon("log-in", __iconNode$aY);
  ...
  const Lollipop = createLucideIcon("lollipop", __iconNode$aV);
  ...
  const Luggage = createLucideIcon("luggage", __iconNode$aU);
  ...
  const Magnet = createLucideIcon("magnet", __iconNode$aT);
  ...
  const MailCheck = createLucideIcon("mail-check", __iconNode$aS);
  ...
  const MailMinus = createLucideIcon("mail-minus", __iconNode$aR);
  ...
  const MailOpen = createLucideIcon("mail-open", __iconNode$aQ);
  ...
  const MailPlus = createLucideIcon("mail-plus", __iconNode$aP);
  ...
  const MailQuestion = createLucideIcon("mail-question", __iconNode$aO);
  ...
  const MailSearch = createLucideIcon("mail-search", __iconNode$aN);
  ...
  const MailWarning = createLucideIcon("mail-warning", __iconNode$aM);
  ...
  const MapPinCheckInside = createLucideIcon("map-pin-check-inside", __iconNode$aH);
  ...
  const MapPinCheck = createLucideIcon("map-pin-check", __iconNode$aG);
  ...
  const MapPinHouse = createLucideIcon("map-pin-house", __iconNode$aF);
  ...
  const MapPinMinusInside = createLucideIcon("map-pin-minus-inside", __iconNode$aE);
  ...
  const MapPinOff = createLucideIcon("map-pin-off", __iconNode$aC);
  ...
  const MapPinPlusInside = createLucideIcon("map-pin-plus-inside", __iconNode$aB);
  ...
  const MapPinPlus = createLucideIcon("map-pin-plus", __iconNode$aA);
  ...
  const MapPinXInside = createLucideIcon("map-pin-x-inside", __iconNode$az);
  ...
  const MapPin = createLucideIcon("map-pin", __iconNode$ax);
  ...
  const MapPinned = createLucideIcon("map-pinned", __iconNode$aw);
  ...
  const MapPlus = createLucideIcon("map-plus", __iconNode$av);
  ...
  const Map = createLucideIcon("map", __iconNode$au);
  ...
  const MarsStroke = createLucideIcon("mars-stroke", __iconNode$at);
  ...
  const Mars = createLucideIcon("mars", __iconNode$as);
  ...
  const Martini = createLucideIcon("martini", __iconNode$ar);
  ...
  const Maximize2 = createLucideIcon("maximize-2", __iconNode$aq);
  ...
  const Maximize = createLucideIcon("maximize", __iconNode$ap);
  ...
  const Medal = createLucideIcon("medal", __iconNode$ao);
  ...
  const Megaphone = createLucideIcon("megaphone", __iconNode$am);
  ...
  const Meh = createLucideIcon("meh", __iconNode$al);
  ...
  const MemoryStick = createLucideIcon("memory-stick", __iconNode$ak);
  ...
  const Menu = createLucideIcon("menu", __iconNode$aj);
  ...
  const Merge = createLucideIcon("merge", __iconNode$ai);
  ...
  const MessageCircleCode = createLucideIcon("message-circle-code", __iconNode$ah);
  ...
  const MessageCircleDashed = createLucideIcon("message-circle-dashed", __iconNode$ag);
  ...
  const MessageCircleHeart = createLucideIcon("message-circle-heart", __iconNode$af);
  ...
  const MessageCircleMore = createLucideIcon("message-circle-more", __iconNode$ae);
  ...
  const MessageCircleOff = createLucideIcon("message-circle-off", __iconNode$ad);
  ...
  const MessageCirclePlus = createLucideIcon("message-circle-plus", __iconNode$ac);
  ...
  const MessageCircleQuestion = createLucideIcon("message-circle-question", __iconNode$ab);
  ...
  const MessageCircleReply = createLucideIcon("message-circle-reply", __iconNode$aa);
  ...
  const MessageCircleX = createLucideIcon("message-circle-x", __iconNode$a8);

  const __iconNode$a7 = [
    ["path", { d: "M7.9 20A9 9 0 1 0 4 16.1L2 22Z", key: "vv11sd" }]
  ];
  const MessageCircle = createLucideIcon("message-circle", __iconNode$a7);
  ...
  const MessageSquareCode = createLucideIcon("message-square-code", __iconNode$a6);
  ...
  const MessageSquareDiff = createLucideIcon("message-square-diff", __iconNode$a4);

  const __iconNode$a3 = [
    ["path", { d: "M11.7 3H5a2 2 0 0 0-2 2v16l4-4h12a2 2 0 0 0 2-2v-2.7", key: "uodpkb" }],
    ["circle", { cx: "18", cy: "6", r: "3", key: "1h7g24" }]
  ];
  const MessageSquareDot = createLucideIcon("message-square-dot", __iconNode$a3);
  ...
  const MessageSquareHeart = createLucideIcon("message-square-heart", __iconNode$a2);
  ...
  const MessageSquareLock = createLucideIcon("message-square-lock", __iconNode$a1);
  ...
  const MessageSquareMore = createLucideIcon("message-square-more", __iconNode$a0);
  ...
  const MessageSquarePlus = createLucideIcon("message-square-plus", __iconNode$9$);
  ...
  const MessageSquareQuote = createLucideIcon("message-square-quote", __iconNode$9Z);
  ...
  const MessageSquareReply = createLucideIcon("message-square-reply", __iconNode$9Y);
  ...
  const MessageSquareShare = createLucideIcon("message-square-share", __iconNode$9X);
  ...
  const MessageSquareText = createLucideIcon("message-square-text", __iconNode$9W);
  ...
  const MessageSquare = createLucideIcon("message-square", __iconNode$9T);
  ...
  const MessagesSquare = createLucideIcon("messages-square", __iconNode$9S);
  ...
  const MicOff = createLucideIcon("mic-off", __iconNode$9R);
  ...
  const MicVocal = createLucideIcon("mic-vocal", __iconNode$9Q);
  ...
  const Mic = createLucideIcon("mic", __iconNode$9P);
  ...
  const Microchip = createLucideIcon("microchip", __iconNode$9O);
  ...
  const Microscope = createLucideIcon("microscope", __iconNode$9N);
  ...
  const Microwave = createLucideIcon("microwave", __iconNode$9M);
  ...
  const Milestone = createLucideIcon("milestone", __iconNode$9L);
  ...
  const Minimize2 = createLucideIcon("minimize-2", __iconNode$9I);
  ...
  const Minimize = createLucideIcon("minimize", __iconNode$9H);
  ...
  const MonitorCog = createLucideIcon("monitor-cog", __iconNode$9E);
  ...
  const MonitorDot = createLucideIcon("monitor-dot", __iconNode$9D);
  ...
  const MonitorDown = createLucideIcon("monitor-down", __iconNode$9C);
  ...
  const MonitorOff = createLucideIcon("monitor-off", __iconNode$9B);
  ...
  const MonitorPause = createLucideIcon("monitor-pause", __iconNode$9A);
  ...
  const MonitorPlay = createLucideIcon("monitor-play", __iconNode$9z);
  ...
  const MonitorSmartphone = createLucideIcon("monitor-smartphone", __iconNode$9y);
  ...
  const MonitorStop = createLucideIcon("monitor-stop", __iconNode$9w);
  ...
  const MonitorUp = createLucideIcon("monitor-up", __iconNode$9v);
  ...
  const MonitorX = createLucideIcon("monitor-x", __iconNode$9u);
  ...
  const Monitor = createLucideIcon("monitor", __iconNode$9t);
  ...
  const MountainSnow = createLucideIcon("mountain-snow", __iconNode$9q);

  const __iconNode$9p = [["path", { d: "m8 3 4 8 5-5 5 15H2L8 3z", key: "otkl63" }]];
  const Mountain = createLucideIcon("mountain", __iconNode$9p);
  ...
  const MouseOff = createLucideIcon("mouse-off", __iconNode$9o);
  ...
  const MousePointer2 = createLucideIcon("mouse-pointer-2", __iconNode$9n);
  ...
  const MousePointerBan = createLucideIcon("mouse-pointer-ban", __iconNode$9m);
  ...
  const MousePointerClick = createLucideIcon("mouse-pointer-click", __iconNode$9l);
  ...
  const MousePointer = createLucideIcon("mouse-pointer", __iconNode$9k);

  const __iconNode$9j = [
    ["rect", { x: "5", y: "2", width: "14", height: "20", rx: "7", key: "11ol66" }],
    ["path", { d: "M12 6v4", key: "16clxf" }]
  ];
  const Mouse = createLucideIcon("mouse", __iconNode$9j);
  ...
  const MoveDiagonal2 = createLucideIcon("move-diagonal-2", __iconNode$9h);
  ...
  const MoveDiagonal = createLucideIcon("move-diagonal", __iconNode$9g);

  const __iconNode$9f = [
    ["path", { d: "M11 19H5V13", key: "1akmht" }],
    ["path", { d: "M19 5L5 19", key: "72u4yj" }]
  ];
  const MoveDownLeft = createLucideIcon("move-down-left", __iconNode$9f);

  const __iconNode$9e = [
    ["path", { d: "M19 13V19H13", key: "10vkzq" }],
    ["path", { d: "M5 5L19 19", key: "5zm2fv" }]
  ];
  const MoveDownRight = createLucideIcon("move-down-right", __iconNode$9e);

  const __iconNode$9d = [
    ["path", { d: "M8 18L12 22L16 18", key: "cskvfv" }],
    ["path", { d: "M12 2V22", key: "r89rzk" }]
  ];
  const MoveDown = createLucideIcon("move-down", __iconNode$9d);
  ...
  const MoveHorizontal = createLucideIcon("move-horizontal", __iconNode$9c);

  const __iconNode$9b = [
    ["path", { d: "M6 8L2 12L6 16", key: "kyvwex" }],
    ["path", { d: "M2 12H22", key: "1m8cig" }]
  ];
  const MoveLeft = createLucideIcon("move-left", __iconNode$9b);

  const __iconNode$9a = [
    ["path", { d: "M18 8L22 12L18 16", key: "1r0oui" }],
    ["path", { d: "M2 12H22", key: "1m8cig" }]
  ];
  const MoveRight = createLucideIcon("move-right", __iconNode$9a);

  const __iconNode$99 = [
    ["path", { d: "M5 11V5H11", key: "3q78g9" }],
    ["path", { d: "M5 5L19 19", key: "5zm2fv" }]
  ];
  const MoveUpLeft = createLucideIcon("move-up-left", __iconNode$99);

  const __iconNode$98 = [
    ["path", { d: "M13 5H19V11", key: "1n1gyv" }],
    ["path", { d: "M19 5L5 19", key: "72u4yj" }]
  ];
  const MoveUpRight = createLucideIcon("move-up-right", __iconNode$98);

  const __iconNode$97 = [
    ["path", { d: "M8 6L12 2L16 6", key: "1yvkyx" }],
    ["path", { d: "M12 2V22", key: "r89rzk" }]
  ];
  const MoveUp = createLucideIcon("move-up", __iconNode$97);
  ...
  const MoveVertical = createLucideIcon("move-vertical", __iconNode$96);
  ...
  const Move = createLucideIcon("move", __iconNode$95);

  const __iconNode$94 = [
    ["circle", { cx: "8", cy: "18", r: "4", key: "1fc0mg" }],
    ["path", { d: "M12 18V2l7 4", key: "g04rme" }]
  ];
  const Music2 = createLucideIcon("music-2", __iconNode$94);

  const __iconNode$93 = [
    ["circle", { cx: "12", cy: "18", r: "4", key: "m3r9ws" }],
    ["path", { d: "M16 18V2", key: "40x2m5" }]
  ];
  const Music3 = createLucideIcon("music-3", __iconNode$93);
  ...
  const Music4 = createLucideIcon("music-4", __iconNode$92);
  ...
  const Navigation2Off = createLucideIcon("navigation-2-off", __iconNode$90);

  const __iconNode$8$ = [
    ["polygon", { points: "12 2 19 21 12 17 5 21 12 2", key: "x8c0qg" }]
  ];
  const Navigation2 = createLucideIcon("navigation-2", __iconNode$8$);
  ...
  const NavigationOff = createLucideIcon("navigation-off", __iconNode$8_);
  ...
  const Network = createLucideIcon("network", __iconNode$8Z);

  const __iconNode$8Y = [
    ["polygon", { points: "3 11 22 2 13 21 11 13 3 11", key: "1ltx0t" }]
  ];
  const Navigation = createLucideIcon("navigation", __iconNode$8Y);
  ...
  const Nfc = createLucideIcon("nfc", __iconNode$8W);
  ...
  const NonBinary = createLucideIcon("non-binary", __iconNode$8V);
  ...
  const NotebookPen = createLucideIcon("notebook-pen", __iconNode$8U);
  ...
  const NotebookTabs = createLucideIcon("notebook-tabs", __iconNode$8T);
  ...
  const NotebookText = createLucideIcon("notebook-text", __iconNode$8S);
  ...
  const Notebook = createLucideIcon("notebook", __iconNode$8R);
  ...
  const NotepadTextDashed = createLucideIcon("notepad-text-dashed", __iconNode$8Q);
  ...
  const NotepadText = createLucideIcon("notepad-text", __iconNode$8P);
  ...
  const NutOff = createLucideIcon("nut-off", __iconNode$8O);
  ...
  const OctagonAlert = createLucideIcon("octagon-alert", __iconNode$8M);
  ...
  const OctagonMinus = createLucideIcon("octagon-minus", __iconNode$8L);
  ...
  const OctagonPause = createLucideIcon("octagon-pause", __iconNode$8K);
  ...
  const OctagonX = createLucideIcon("octagon-x", __iconNode$8J);
  ...
  const Octagon = createLucideIcon("octagon", __iconNode$8I);
  ...
  const Omega = createLucideIcon("omega", __iconNode$8H);

  const __iconNode$8G = [
    ["path", { d: "M3 3h6l6 18h6", key: "ph9rgk" }],
    ["path", { d: "M14 3h7", key: "16f0ms" }]
  ];
  const Option = createLucideIcon("option", __iconNode$8G);
  ...
  const Orbit = createLucideIcon("orbit", __iconNode$8F);
  ...
  const Origami = createLucideIcon("origami", __iconNode$8E);
  ...
  const Package2 = createLucideIcon("package-2", __iconNode$8D);
  ...
  const PackageCheck = createLucideIcon("package-check", __iconNode$8C);
  ...
  const PackageMinus = createLucideIcon("package-minus", __iconNode$8B);
  ...
  const PackageOpen = createLucideIcon("package-open", __iconNode$8A);
  ...
  const PackagePlus = createLucideIcon("package-plus", __iconNode$8z);
  ...
  const PackageSearch = createLucideIcon("package-search", __iconNode$8y);
  ...
  const PackageX = createLucideIcon("package-x", __iconNode$8x);
  ...
  const Package = createLucideIcon("package", __iconNode$8w);
  ...
  const PaintBucket = createLucideIcon("paint-bucket", __iconNode$8v);
  ...
  const PaintRoller = createLucideIcon("paint-roller", __iconNode$8u);
  ...
  const PaintbrushVertical = createLucideIcon("paintbrush-vertical", __iconNode$8t);
  ...
  const Paintbrush = createLucideIcon("paintbrush", __iconNode$8s);
  ...
  const Palette = createLucideIcon("palette", __iconNode$8r);
  ...
  const PanelBottomClose = createLucideIcon("panel-bottom-close", __iconNode$8q);
  ...
  const PanelBottomDashed = createLucideIcon("panel-bottom-dashed", __iconNode$8p);
  ...
  const PanelBottomOpen = createLucideIcon("panel-bottom-open", __iconNode$8o);

  const __iconNode$8n = [
    ["rect", { width: "18", height: "18", x: "3", y: "3", rx: "2", key: "afitv7" }],
    ["path", { d: "M3 15h18", key: "5xshup" }]
  ];
  const PanelBottom = createLucideIcon("panel-bottom", __iconNode$8n);
  ...
  const PanelLeftDashed = createLucideIcon("panel-left-dashed", __iconNode$8l);
  ...
  const PanelLeft = createLucideIcon("panel-left", __iconNode$8j);
  ...
  const PanelRightClose = createLucideIcon("panel-right-close", __iconNode$8i);
  ...
  const PanelRightDashed = createLucideIcon("panel-right-dashed", __iconNode$8h);
  ...
  const PanelRightOpen = createLucideIcon("panel-right-open", __iconNode$8g);

  const __iconNode$8f = [
    ["rect", { width: "18", height: "18", x: "3", y: "3", rx: "2", key: "afitv7" }],
    ["path", { d: "M15 3v18", key: "14nvp0" }]
  ];
  const PanelRight = createLucideIcon("panel-right", __iconNode$8f);
  ...
  const PanelTopClose = createLucideIcon("panel-top-close", __iconNode$8e);
  ...
  const PanelTopDashed = createLucideIcon("panel-top-dashed", __iconNode$8d);
  ...
  const PanelTopOpen = createLucideIcon("panel-top-open", __iconNode$8c);
  ...
  const PanelsLeftBottom = createLucideIcon("panels-left-bottom", __iconNode$8a);
  ...
  const PanelsRightBottom = createLucideIcon("panels-right-bottom", __iconNode$89);
  ...
  const PanelsTopLeft = createLucideIcon("panels-top-left", __iconNode$88);
  ...
  const Paperclip = createLucideIcon("paperclip", __iconNode$87);

  const __iconNode$86 = [
    ["path", { d: "M8 21s-4-3-4-9 4-9 4-9", key: "uto9ud" }],
    ["path", { d: "M16 3s4 3 4 9-4 9-4 9", key: "4w2vsq" }]
  ];
  const Parentheses = createLucideIcon("parentheses", __iconNode$86);
  ...
  const ParkingMeter = createLucideIcon("parking-meter", __iconNode$85);
  ...
  const Pause = createLucideIcon("pause", __iconNode$83);
  ...
  const PawPrint = createLucideIcon("paw-print", __iconNode$82);
  ...
  const PcCase = createLucideIcon("pc-case", __iconNode$81);
  ...
  const PenLine = createLucideIcon("pen-line", __iconNode$80);
  ...
  const PenOff = createLucideIcon("pen-off", __iconNode$7$);
  ...
  const PenTool = createLucideIcon("pen-tool", __iconNode$7_);
  ...
  const Pen = createLucideIcon("pen", __iconNode$7Z);
  ...
  const PencilLine = createLucideIcon("pencil-line", __iconNode$7Y);
  ...
  const PencilOff = createLucideIcon("pencil-off", __iconNode$7X);
  ...
  const PencilRuler = createLucideIcon("pencil-ruler", __iconNode$7W);
  ...
  const Pencil = createLucideIcon("pencil", __iconNode$7V);
  ...
  const Pentagon = createLucideIcon("pentagon", __iconNode$7U);
  ...
  const PersonStanding = createLucideIcon("person-standing", __iconNode$7S);
  ...
  const PhilippinePeso = createLucideIcon("philippine-peso", __iconNode$7R);
  ...
  const PhoneCall = createLucideIcon("phone-call", __iconNode$7Q);
  ...
  const PhoneForwarded = createLucideIcon("phone-forwarded", __iconNode$7P);
  ...
  const PhoneIncoming = createLucideIcon("phone-incoming", __iconNode$7O);
  ...
  const PhoneMissed = createLucideIcon("phone-missed", __iconNode$7N);
  ...
  const PhoneOff = createLucideIcon("phone-off", __iconNode$7M);
  ...
  const Pi = createLucideIcon("pi", __iconNode$7J);
  ...
  const Piano = createLucideIcon("piano", __iconNode$7I);
  ...
  const Pickaxe = createLucideIcon("pickaxe", __iconNode$7H);

  const __iconNode$7G = [
    ["path", { d: "M21 9V6a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2v10c0 1.1.9 2 2 2h4", key: "daa4of" }],
    ["rect", { width: "10", height: "7", x: "12", y: "13", rx: "2", key: "1nb8gs" }]
  ];
  const PictureInPicture2 = createLucideIcon("picture-in-picture-2", __iconNode$7G);
  ...
  const PictureInPicture = createLucideIcon("picture-in-picture", __iconNode$7F);
  ...
  const PiggyBank = createLucideIcon("piggy-bank", __iconNode$7E);
  ...
  const PilcrowLeft = createLucideIcon("pilcrow-left", __iconNode$7D);
  ...
  const PilcrowRight = createLucideIcon("pilcrow-right", __iconNode$7C);
  ...
  const Pilcrow = createLucideIcon("pilcrow", __iconNode$7B);
  ...
  const Pill = createLucideIcon("pill", __iconNode$7z);
  ...
  const PinOff = createLucideIcon("pin-off", __iconNode$7y);
  ...
  const Pin = createLucideIcon("pin", __iconNode$7x);
  ...
  const Pipette = createLucideIcon("pipette", __iconNode$7w);
  ...
  const Pizza = createLucideIcon("pizza", __iconNode$7v);
  ...
  const PlaneLanding = createLucideIcon("plane-landing", __iconNode$7u);
  ...
  const Plane = createLucideIcon("plane", __iconNode$7s);

  const __iconNode$7r = [["polygon", { points: "6 3 20 12 6 21 6 3", key: "1oa8hb" }]];
  const Play = createLucideIcon("play", __iconNode$7r);
  ...
  const PlugZap = createLucideIcon("plug-zap", __iconNode$7p);
  ...
  const Plug = createLucideIcon("plug", __iconNode$7o);

  const __iconNode$7n = [
    ["path", { d: "M5 12h14", key: "1ays0h" }],
    ["path", { d: "M12 5v14", key: "s699le" }]
  ];
  const Plus = createLucideIcon("plus", __iconNode$7n);
  ...
  const PocketKnife = createLucideIcon("pocket-knife", __iconNode$7m);
  ...
  const Pocket = createLucideIcon("pocket", __iconNode$7l);
  ...
  const Podcast = createLucideIcon("podcast", __iconNode$7k);
  ...
  const PointerOff = createLucideIcon("pointer-off", __iconNode$7j);
  ...
  const Pointer = createLucideIcon("pointer", __iconNode$7i);
  ...
  const Popcorn = createLucideIcon("popcorn", __iconNode$7h);
  ...
  const Popsicle = createLucideIcon("popsicle", __iconNode$7g);
  ...
  const PoundSterling = createLucideIcon("pound-sterling", __iconNode$7f);
  ...
  const PowerOff = createLucideIcon("power-off", __iconNode$7e);

  const __iconNode$7d = [
    ["path", { d: "M12 2v10", key: "mnfbl" }],
    ["path", { d: "M18.4 6.6a9 9 0 1 1-12.77.04", key: "obofu9" }]
  ];
  const Power = createLucideIcon("power", __iconNode$7d);
  ...
  const Presentation = createLucideIcon("presentation", __iconNode$7c);
  ...
  const PrinterCheck = createLucideIcon("printer-check", __iconNode$7b);
  ...
  const Projector = createLucideIcon("projector", __iconNode$79);
  ...
  const Proportions = createLucideIcon("proportions", __iconNode$78);
  ...
  const Puzzle = createLucideIcon("puzzle", __iconNode$77);
  ...
  const Pyramid = createLucideIcon("pyramid", __iconNode$76);
  ...
  const QrCode = createLucideIcon("qr-code", __iconNode$75);
  ...
  const Rabbit = createLucideIcon("rabbit", __iconNode$73);
  ...
  const Radar = createLucideIcon("radar", __iconNode$72);
  ...
  const Radical = createLucideIcon("radical", __iconNode$70);
  ...
  const RadioReceiver = createLucideIcon("radio-receiver", __iconNode$6$);
  ...
  const RadioTower = createLucideIcon("radio-tower", __iconNode$6_);
  ...
  const Radio = createLucideIcon("radio", __iconNode$6Z);
  ...
  const Radius = createLucideIcon("radius", __iconNode$6Y);
  ...
  const RailSymbol = createLucideIcon("rail-symbol", __iconNode$6X);
  ...
  const Rainbow = createLucideIcon("rainbow", __iconNode$6W);
  ...
  const Rat = createLucideIcon("rat", __iconNode$6V);

  const __iconNode$6U = [
    ["rect", { width: "12", height: "20", x: "6", y: "2", rx: "2", key: "1oxtiu" }],
    ["rect", { width: "20", height: "12", x: "2", y: "6", rx: "2", key: "9lu3g6" }]
  ];
  const Ratio = createLucideIcon("ratio", __iconNode$6U);
  ...
  const ReceiptCent = createLucideIcon("receipt-cent", __iconNode$6T);
  ...
  const ReceiptEuro = createLucideIcon("receipt-euro", __iconNode$6S);
  ...
  const ReceiptIndianRupee = createLucideIcon("receipt-indian-rupee", __iconNode$6R);
  ...
  const ReceiptJapaneseYen = createLucideIcon("receipt-japanese-yen", __iconNode$6Q);
  ...
  const ReceiptPoundSterling = createLucideIcon("receipt-pound-sterling", __iconNode$6P);
  ...
  const ReceiptRussianRuble = createLucideIcon("receipt-russian-ruble", __iconNode$6O);
  ...
  const ReceiptSwissFranc = createLucideIcon("receipt-swiss-franc", __iconNode$6N);
  ...
  const ReceiptText = createLucideIcon("receipt-text", __iconNode$6M);
  ...
  const Receipt = createLucideIcon("receipt", __iconNode$6L);
  ...
  const RectangleEllipsis = createLucideIcon("rectangle-ellipsis", __iconNode$6K);

  const __iconNode$6J = [
    ["rect", { width: "20", height: "12", x: "2", y: "6", rx: "2", key: "9lu3g6" }]
  ];
  const RectangleHorizontal = createLucideIcon("rectangle-horizontal", __iconNode$6J);
  ...
  const RefreshCwOff = createLucideIcon("refresh-cw-off", __iconNode$6B);
  ...
  const RefreshCw = createLucideIcon("refresh-cw", __iconNode$6A);
  ...
  const Refrigerator = createLucideIcon("refrigerator", __iconNode$6z);
  ...
  const Regex = createLucideIcon("regex", __iconNode$6y);
  ...
  const Repeat2 = createLucideIcon("repeat-2", __iconNode$6v);
  ...
  const Repeat = createLucideIcon("repeat", __iconNode$6u);
  ...
  const ScanQrCode = createLucideIcon("scan-qr-code", __iconNode$5R);
  ...
  const SquareM = createLucideIcon("square-m", __iconNode$3O);
  ...
  const SquareLibrary = createLucideIcon("square-library", __iconNode$3N);
  ...
  const SquareRoundCorner = createLucideIcon("square-round-corner", __iconNode$3A);
  ...
  const Sticker = createLucideIcon("sticker", __iconNode$3e);

  const __iconNode$3d = [
    ["path", { d: "M16 3H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V8Z", key: "qazsjp" }],
    ["path", { d: "M15 3v4a2 2 0 0 0 2 2h4", key: "40519r" }]
  ];
  const StickyNote = createLucideIcon("sticky-note", __iconNode$3d);
  ...
  const StretchVertical = createLucideIcon("stretch-vertical", __iconNode$3a);

  const __iconNode$39 = [
    ["rect", { width: "20", height: "6", x: "2", y: "4", rx: "2", key: "qdearl" }],
    ["rect", { width: "20", height: "6", x: "2", y: "14", rx: "2", key: "1xrn6j" }]
  ];
  const StretchHorizontal = createLucideIcon("stretch-horizontal", __iconNode$39);
  ...
  const SunMedium = createLucideIcon("sun-medium", __iconNode$36);
  ...
  const SunDim = createLucideIcon("sun-dim", __iconNode$35);
  ...
  const TableProperties = createLucideIcon("table-properties", __iconNode$2Q);
  ...
  const TableOfContents = createLucideIcon("table-of-contents", __iconNode$2P);
  ...
  const TabletSmartphone = createLucideIcon("tablet-smartphone", __iconNode$2N);
  ...
  const Table = createLucideIcon("table", __iconNode$2M);
  ...
  const Tags = createLucideIcon("tags", __iconNode$2J);
  ...
  const Tag = createLucideIcon("tag", __iconNode$2I);
  ...
  const Umbrella = createLucideIcon("umbrella", __iconNode$1t);

  const __iconNode$1s = [
    ["path", { d: "M6 4v6a6 6 0 0 0 12 0V4", key: "9kb039" }],
    ["line", { x1: "4", x2: "20", y1: "20", y2: "20", key: "nun2al" }]
  ];
  const Underline = createLucideIcon("underline", __iconNode$1s);
  ...
  const UserRoundPen = createLucideIcon("user-round-pen", __iconNode$15);
  ...
  const Vegan = createLucideIcon("vegan", __iconNode$S);
  ...
  const VibrateOff = createLucideIcon("vibrate-off", __iconNode$N);
  ...
  const Volume1 = createLucideIcon("volume-1", __iconNode$G);
  ...
  const Webhook = createLucideIcon("webhook", __iconNode$m);
